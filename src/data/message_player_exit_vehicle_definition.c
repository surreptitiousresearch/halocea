/* message_player_exit_vehicle_definition @ 0x841760F8 (.data, 88 bytes) — the message-delta message definition for
 * `_message_player_exit_vehicle` (id 9): a player has left a vehicle.
 ...
 *   +0x00 definition_type                    = 0x00000009 -> _message_player_exit_vehicle
 ...
 * 0x84176150, i.e. 88 bytes, and 0x28 + (2 + 1) * 16 == 88 — 16 being the DB member stride of
...
_message_definition message_player_exit_vehicle_definition =
{
    _message_player_exit_vehicle,            /* definition_type */
