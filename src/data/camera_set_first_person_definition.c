/* camera_set_first_person_definition @ 0x8211AF2C — hs_function_table entry for the HaloScript "camera_set_first_person" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117178 -> "camera_set_first_person"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372B4E8 -> scripted_camera_set_first_person_evaluate
...
extern void scripted_camera_set_first_person_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition camera_set_first_person_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "camera_set_first_person",   /* name */
    hs_macro_function_parse,     /* parse */
    scripted_camera_set_first_person_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
