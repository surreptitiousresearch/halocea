/* pause_hud_timer_definition @ 0x8211C0E0 — hs_function_table entry for the HaloScript "pause_hud_timer" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821164AC -> "pause_hud_timer"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D8C0 -> scripted_hud_pause_timer_evaluate
...
extern void scripted_hud_pause_timer_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition pause_hud_timer_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "pause_hud_timer",           /* name */
    hs_macro_function_parse,     /* parse */
    scripted_hud_pause_timer_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
