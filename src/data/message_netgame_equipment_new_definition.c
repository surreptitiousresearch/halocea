/* message_netgame_equipment_new_definition @ 0x8417D8E0 (.data, 104 bytes) — the message-delta message definition for
 * `_message_netgame_equipment_new` (id 42): a netgame equipment item has been created.
 ...
 *   +0x00 definition_type                    = 0x0000002A -> _message_netgame_equipment_new
 ...
 * 0x8417D948, i.e. 104 bytes, and 0x28 + (3 + 1) * 16 == 104 — 16 being the DB member stride of
...
_message_definition message_netgame_equipment_new_definition =
{
    _message_netgame_equipment_new,          /* definition_type */
