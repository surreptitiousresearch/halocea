/* game_time_definition @ 0x8211AFE0 — hs_function_table entry for the HaloScript "game_time" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0008 -> hs_type_long_integer
 *   +0x04 name                   = 0x82117118 -> "game_time"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372B678 -> game_time_get_evaluate
...
extern void game_time_get_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition game_time_definition =
{
    hs_type_long_integer,        /* return_type */
    { 0, 0 },                    /* _pad02 */
    "game_time",                 /* name */
    hs_macro_function_parse,     /* parse */
    game_time_get_evaluate,      /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
