/* D3DDevice_SetStreamSource_Inline_7 @0x83D32B90 */
...
void D3DDevice_SetStreamSource_Inline_7(D3DDevice *pDevice, unsigned int StreamNumber, D3DVertexBuffer *pStreamData, unsigned int OffsetInBytes, unsigned int Stride)
{
