...
extern void action_obey_individuals_iterate(int actor_index, unsigned __int8 initialize_structures,
    ...
    void (__fastcall *iterator)(int, int, __int16, obey_individual_simple_control *, obey_individual_complex_control *, void *),
    void *user_data);
extern void action_obey_individual_flush_command_indices(int actor_index, int unit_index, __int16 command_list_index,
