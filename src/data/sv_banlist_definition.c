/* sv_banlist_definition @ 0x8211C7CC — hs_function_table entry for the HaloScript "sv_banlist" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115F00 -> "sv_banlist"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E688 -> sv_banlist_evaluate
 *   +0x10 documentation          = 0x82115EE0
...
extern void sv_banlist_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_banlist_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_banlist",                /* name */
    hs_macro_function_parse,     /* parse */
    sv_banlist_evaluate,         /* evaluate */
    "Print a list of banned players", /* documentation */
    0,                           /* parameters */
