/* build_game_variant_team_slayer @0x8374EE90 — default "Team Slayer" variant: Slayer (engine 2) with
 * teams, 50 kills to win, a 300-tick respawn, and no radar. */
...
game_variant * build_game_variant_team_slayer(game_variant *result)
{
