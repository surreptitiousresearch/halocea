/* set_gamma_definition @ 0x8211C178 — hs_function_table entry for the HaloScript "set_gamma" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8211645C -> "set_gamma"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D980 -> rasterizer_dx9_gamma_set_value_evaluate
...
extern void rasterizer_dx9_gamma_set_value_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition set_gamma_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "set_gamma",                 /* name */
    hs_macro_function_parse,     /* parse */
    rasterizer_dx9_gamma_set_value_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
