/* ?RenderUIStat@UI_STAT_SYS@ui_new@@QAAXXZ @0x82CF02C8 */
...
void ui_new::UI_STAT_SYS::RenderUIStat()
{
    ...
    if (!IGNORE_STRONG_ASSERT && lock.lockDepth > 0)
        static_cast<STRONG_ASSERT_DUMMY *>(nullptr)->Crash("! lock.IsLocked()", "D:\\Projects\\code\\common\\src.sys\\gm_sys\\ui\\ui_stat.cpp", 325, empty_string);
