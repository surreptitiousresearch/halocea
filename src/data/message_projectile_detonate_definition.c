/* message_projectile_detonate_definition @ 0x8417E950 (.data, 88 bytes) — the message-delta message definition for
 * `_message_projectile_detonate` (id 43): a projectile has detonated.
 ...
 *   +0x00 definition_type                    = 0x0000002B -> _message_projectile_detonate
 ...
 *   +0x38   field_references[ 1]             = { 0x84183C08 -> &field_properties_point3d_definition, offset 4, baseline_offset 4, initialized 0 }
 ...
 * 0x8417E9A8, i.e. 88 bytes, and 0x28 + (2 + 1) * 16 == 88 — 16 being the DB member stride of
...
_message_definition message_projectile_detonate_definition =
{
    _message_projectile_detonate,            /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_point3d_definition, 4, 4, 0 },       /* [ 1] */
