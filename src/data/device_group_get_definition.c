/* device_group_get_definition @ 0x8211A160 — hs_function_table entry for the HaloScript "device_group_get" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0006 -> hs_type_real
 *   +0x04 name                   = 0x82117A38 -> "device_group_get"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x837293D0 -> device_group_get_value_evaluate
 *   +0x10 documentation          = 0x8200155A
 *   +0x14 parameters             = 0x00000000 (NULL)
 *   +0x18 console_flags          = 0x00
 *   +0x1A formal_parameter_count = 1  (+0x1C formal_parameters = hs_type_device_group)
 */
...
extern void device_group_get_value_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition device_group_get_definition =
{
    hs_type_real,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "device_group_get",          /* name */
    hs_macro_function_parse,     /* parse */
    device_group_get_value_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
    1,                           /* formal_parameter_count */
    { hs_type_device_group },  /* formal_parameters */
};
