...
class dbgVAR; // boundary — dbg subsystem debug variable (element is a pointer)

// dsVECTOR<dbgVAR*,8>::ShrinkResize @ 0x8255E610
...
template<>
void dsVECTOR<dbgVAR *, 8>::ShrinkResize(int size)
{
