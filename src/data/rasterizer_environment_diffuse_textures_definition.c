/* rasterizer_environment_diffuse_textures_definition @ 0x84180C20 -- second-order .data; hs_global_external (16B, big-endian) reconstructed
...
hs_global_external rasterizer_environment_diffuse_textures_definition =
{
    ...
    hs_type_boolean,
    { 0, 0 },
    (char *)&rasterizer_debug_options + 20,
    0
};
