/* magic_seat_name_definition @ 0x82119E68 — hs_function_table entry for the HaloScript "magic_seat_name" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117C70 -> "magic_seat_name"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728C70 -> scripting_set_magic_base_seat_evaluate
...
extern void scripting_set_magic_base_seat_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition magic_seat_name_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "magic_seat_name",           /* name */
    hs_macro_function_parse,     /* parse */
    scripting_set_magic_base_seat_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
