/* sound_set_master_gain_definition @ 0x8211BAAC — hs_function_table entry for the HaloScript "sound_set_master_gain" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116930 -> "sound_set_master_gain"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372CAD0 -> sound_set_master_gain_evaluate
...
extern void sound_set_master_gain_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sound_set_master_gain_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sound_set_master_gain",     /* name */
    hs_macro_function_parse,     /* parse */
    sound_set_master_gain_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
