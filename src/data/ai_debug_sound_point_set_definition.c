/* ai_debug_sound_point_set_definition @ 0x8211B4C8 — hs_function_table entry for the HaloScript "ai_debug_sound_point_set" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116D0C -> "ai_debug_sound_point_set"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BF38 -> ai_debug_sound_point_set_evaluate
...
extern void ai_debug_sound_point_set_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_debug_sound_point_set_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_debug_sound_point_set",  /* name */
    hs_macro_function_parse,     /* parse */
    ai_debug_sound_point_set_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
