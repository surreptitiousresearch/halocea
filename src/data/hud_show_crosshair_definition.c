/* hud_show_crosshair_definition @ 0x8211BFE0 — hs_function_table entry for the HaloScript "hud_show_crosshair" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116554 -> "hud_show_crosshair"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D678 -> scripted_hud_show_crosshair_evaluate
...
extern void scripted_hud_show_crosshair_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition hud_show_crosshair_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "hud_show_crosshair",        /* name */
    hs_macro_function_parse,     /* parse */
    scripted_hud_show_crosshair_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
