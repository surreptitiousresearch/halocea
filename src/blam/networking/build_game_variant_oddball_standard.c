/* build_game_variant_oddball_standard @0x8374ADC0 — "Oddball" standard-lobby variant: oddball engine (3),
 * no teams, 150-tick instant respawn, 2 points to win, weapon set 0 (default), vehicle sets 0x09240000,
 * normal ball type, no traits, standard flags mask (0xFFFFFE00 | 0x103). */
...
game_variant * build_game_variant_oddball_standard(game_variant *result)
{
