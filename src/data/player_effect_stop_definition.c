/* player_effect_stop_definition @ 0x8211BF00 — hs_function_table entry for the HaloScript "player_effect_stop" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821165E0 -> "player_effect_stop"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D480 -> scripted_player_effect_stop_evaluate
...
extern void scripted_player_effect_stop_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition player_effect_stop_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "player_effect_stop",        /* name */
    hs_macro_function_parse,     /* parse */
    scripted_player_effect_stop_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
