/* debug_tags_definition @ 0x8211B3F4 — hs_function_table entry for the HaloScript "debug_tags" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116D94 -> "debug_tags"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BEC8 -> tag_groups_dump_memory_evaluate
...
extern void tag_groups_dump_memory_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition debug_tags_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "debug_tags",                /* name */
    hs_macro_function_parse,     /* parse */
    tag_groups_dump_memory_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
