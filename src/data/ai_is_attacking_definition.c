/* ai_is_attacking_definition @ 0x8211ACE8 — hs_function_table entry for the HaloScript "ai_is_attacking" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x821172C8 -> "ai_is_attacking"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372AF00 -> ai_scripting_is_attacking_evaluate
...
extern void ai_scripting_is_attacking_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_is_attacking_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_is_attacking",           /* name */
    hs_macro_function_parse,     /* parse */
    ai_scripting_is_attacking_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
