...
// aiPLANNER::cbNoticeFlyingRocket @ 0x83254650
// ?cbNoticeFlyingRocket@aiPLANNER@@QAAXHPAVdsDATA@@AAV2@VsslOBJ_REF@@@Z
//
// SSL callback: resolve the object reference in argv[0] against the script system to an actor and
// forward it to implNoticeFlyingRocket. `caller` releases on return.
void aiPLANNER::cbNoticeFlyingRocket(int /*argc*/, dsDATA *argv, dsDATA & /*retVal*/,
                                     sslOBJ_REF /*caller*/)
{
    sslOBJ_REF ref;
