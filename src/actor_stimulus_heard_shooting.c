/* actor_stimulus_heard_shooting @0x837D4C60 — react to hearing weapon fire reported by a perception prop.
...
extern void actor_derive_target_information(int actor_index, uint16_t friend_actor_index);
...
void actor_stimulus_heard_shooting(uint16_t actor_index, uint16_t prop_index)
{
