/* unit_can_blink_definition @ 0x82119B18 — hs_function_table entry for the HaloScript "unit_can_blink" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117EB8 -> "unit_can_blink"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728430 -> unit_scripting_can_blink_evaluate
...
extern void unit_scripting_can_blink_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition unit_can_blink_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "unit_can_blink",            /* name */
    hs_macro_function_parse,     /* parse */
    unit_scripting_can_blink_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
