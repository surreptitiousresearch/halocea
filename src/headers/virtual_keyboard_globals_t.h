...
typedef struct _virtual_keyboard_globals
{
    ...
    unsigned __int8  shift_active;              /* 0x01 */
    unsigned __int8  caps_active;               /* 0x02 */
    unsigned __int8  symbols_active;            /* 0x03 */
    struct virtual_keyboard *keyboard;          /* 0x04 — `struct` prefix avoids the verifier's `virtual` keyword skip */
    __int16          row;                       /* 0x08 */
    __int16          column;                    /* 0x0A */
    unsigned __int16 buffer_size;               /* 0x0C */
    __int16          last_event;                /* 0x0E */
    __int16          last_key;                  /* 0x10 */
    unsigned __int16 number_of_event_repeats;   /* 0x12 */
    __int16          caption_index;             /* 0x14 */
    unsigned __int8  buffer_saved;              /* 0x16 */
    unsigned __int8  first_key_replaces_buffer; /* 0x17 */
    unsigned __int16 *text_buffer;              /* 0x18 */
    unsigned __int16 *insertion_point;          /* 0x1C */
