/* message_game_engine_change_mode_definition @ 0x8417DB48 (.data, 72 bytes) — the message-delta message definition for
 * `_message_game_engine_change_mode` (id 22): the game engine has changed mode.
 ...
 *   +0x00 definition_type                    = 0x00000016 -> _message_game_engine_change_mode
 ...
 * 0x8417DB90, i.e. 72 bytes, and 0x28 + (1 + 1) * 16 == 72 — 16 being the DB member stride of
...
_message_definition message_game_engine_change_mode_definition =
{
    _message_game_engine_change_mode,        /* definition_type */
