...
typedef struct _shader_transparent_generic
{
    ...
    int16_t         type;                        /* 0x02 — shader_transparent_generic_type (first map type); shader_transparent_generic_type.h, DB $9FCCCEA89881530A1DDE69E22F470E0D. Sole image read: shader_get_vertex_shader_permutation @0x83755638 (lhz 0x2A, +1 bias) */
