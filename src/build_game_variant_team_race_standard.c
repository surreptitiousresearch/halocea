/* build_game_variant_team_race_standard @0x8374B240 — "standard" (matchmaking-rules) Team Race variant:
 * race engine (5) with teams, autobalance and a 300-tick friendly-fire penalty, 3 laps, standard vehicle
 * set (0x09240000) respawning in 900 ticks, and a 10-minute time limit. */
...
game_variant * build_game_variant_team_race_standard(game_variant *result)
{
