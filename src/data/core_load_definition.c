/* core_load_definition @ 0x8211C754 — hs_function_table entry for the HaloScript "core_load" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115F30 -> "core_load"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E588 -> main_load_core_evaluate
...
extern void main_load_core_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition core_load_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "core_load",                 /* name */
    hs_macro_function_parse,     /* parse */
    main_load_core_evaluate,     /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
