/* _field_type_fixed_width_parameter_verifier @0x8379C3D0 — the fixed-width field type's
...
uint8_t _field_type_fixed_width_parameter_verifier(const _field_properties_definition *const field_properties_definition)
{
