/* begin_definition @ 0x82119008 — hs_function_table entry for the HaloScript "begin" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0003 -> hs_passthrough
 *   +0x04 name                   = 0x82118CC4 -> "begin"
 *   +0x08 parse                  = 0x83778A58 -> hs_parse_begin
 *   +0x0C evaluate               = 0x8368EBF0 -> hs_evaluate_begin
 *   +0x10 documentation          = 0x82118C70
...
extern void hs_evaluate_begin(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition begin_definition =
{
    hs_passthrough,              /* return_type */
    { 0, 0 },                    /* _pad02 */
    "begin",                     /* name */
    hs_parse_begin,              /* parse */
    hs_evaluate_begin,           /* evaluate */
    "returns the last expression in a sequence after evaluating the sequence in order.", /* documentation */
