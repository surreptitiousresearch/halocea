/* ai_strength_definition @ 0x8211AD88 — hs_function_table entry for the HaloScript "ai_strength" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0006 -> hs_type_real
 *   +0x04 name                   = 0x8211726C -> "ai_strength"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372B0B0 -> ai_scripting_strength_evaluate
...
extern void ai_scripting_strength_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_strength_definition =
{
    hs_type_real,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_strength",               /* name */
    hs_macro_function_parse,     /* parse */
    ai_scripting_strength_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
