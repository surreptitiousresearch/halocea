/* build_game_variant_race @0x8374FB80 — default "Race" variant: race engine (5), instant respawn,
 * 3 laps to win, 300-tick suicide penalty, all weapons/vehicles, normal course order
 * (terminator.ignored = 0 in the race view) and individual scoring (single_flag_time = 0). */
...
game_variant * build_game_variant_race(game_variant *result)
{
