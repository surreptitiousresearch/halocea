/* hud_set_objective_text_definition @ 0x8211C03C — hs_function_table entry for the HaloScript "hud_set_objective_text" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116514 -> "hud_set_objective_text"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D740 -> scripted_hud_set_objective_evaluate
 *   +0x10 documentation          = 0x8200155A
 *   +0x14 parameters             = 0x00000000 (NULL)
 *   +0x18 console_flags          = 0x00
 *   +0x1A formal_parameter_count = 1  (+0x1C formal_parameters = hs_type_hud_message)
 */
...
extern void scripted_hud_set_objective_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition hud_set_objective_text_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "hud_set_objective_text",    /* name */
    hs_macro_function_parse,     /* parse */
    scripted_hud_set_objective_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
    1,                           /* formal_parameter_count */
    { hs_type_hud_message },  /* formal_parameters */
};
