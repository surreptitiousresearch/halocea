...
extern int _field_type_smart_vector_size_calculator(_field_properties_definition *const field_properties_definition);
extern uint8_t _field_type_smart_vector_parameter_verifier(const _field_properties_definition *const field_properties_definition);
