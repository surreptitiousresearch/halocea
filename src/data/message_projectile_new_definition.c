/* message_projectile_new_definition @ 0x8417EA10 (.data, 232 bytes) — the message-delta message definition for
 * `_message_projectile_new` (id 29): a new projectile has been created.
 * The message carries no per-message header (header_fields is the shared empty NO_HEADER set);
 * 11 body fields.
 * Encoder call site cross-checked in headers/message_delta_message_ids.h: 0x8375A650 passes id 29.
 *
 * Per-field provenance, decoded big-endian straight from the image bytes:
 *   +0x00 definition_type                    = 0x0000001D -> _message_projectile_new
 ...
 *   +0x98   field_references[ 7]             = { 0x84184160 -> &field_properties_angular_velocity_definition, offset 68, baseline_offset 68, initialized 0 }
 *   +0xA8   field_references[ 8]             = { 0x841832D0 -> &field_properties_integer_small_definition, offset 80, baseline_offset 80, initialized 0 }
 *   +0xB8   field_references[ 9]             = { 0x841837C0 -> &field_properties_locality_reference_position_definition, offset 20, baseline_offset 20, initialized 0 }
 ...
 * 0x8417EAF8, i.e. 232 bytes, and 0x28 + (11 + 1) * 16 == 232 — 16 being the DB member stride of
...
_message_definition message_projectile_new_definition =
{
    _message_projectile_new,                 /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_angular_velocity_definition, 68, 68, 0 },             /* [ 7] */
            { &field_properties_integer_small_definition, 80, 80, 0 },                /* [ 8] */
            { &field_properties_locality_reference_position_definition, 20, 20, 0 },  /* [ 9] */
