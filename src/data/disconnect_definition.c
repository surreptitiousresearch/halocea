/* disconnect_definition @ 0x8211C684 — hs_function_table entry for the HaloScript "disconnect" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8211600C -> "disconnect"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E440 -> network_game_client_disconnect_evaluate
 *   +0x10 documentation          = 0x82115FF0
...
extern void network_game_client_disconnect_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition disconnect_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "disconnect",                /* name */
    hs_macro_function_parse,     /* parse */
    network_game_client_disconnect_evaluate, /* evaluate */
    "Disconnect from a server",  /* documentation */
    0,                           /* parameters */
