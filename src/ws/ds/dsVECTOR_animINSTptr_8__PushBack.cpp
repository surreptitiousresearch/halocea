...
class animINST; // boundary — anim engine skeletal-animation instance (opaque; element is a pointer)

// dsVECTOR<animINST *,8>::PushBack @ 0x823EE308
...
template<>
animINST *&dsVECTOR<animINST *, 8>::PushBack(animINST *const &val)
{
