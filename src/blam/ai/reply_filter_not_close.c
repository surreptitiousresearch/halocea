...
uint8_t reply_filter_not_close(int original_unit_index, ai_information_packet *communication, int reply_actor_index)
{
    ...
    return prop->distance > 5.0f || (unsigned int)prop->line_of_sight >= _ai_line_of_sight_from_cover;
}
