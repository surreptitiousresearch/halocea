/* object_type_update_timestamped_from_network @0x837027C0 */
...
void object_type_update_timestamped_from_network(message_delta_processor_header *header, network_game_client *client)
{
