/* units_set_current_vitality_definition @ 0x82119E00 — hs_function_table entry for the HaloScript "units_set_current_vitality" function.
 * Initializer reconstructed from the binary .rdata record (36 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117CA4 -> "units_set_current_vitality"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728B60 -> units_scripting_set_current_vitality_evaluate
...
extern void units_scripting_set_current_vitality_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition units_set_current_vitality_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "units_set_current_vitality", /* name */
    hs_macro_function_parse,     /* parse */
    units_scripting_set_current_vitality_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
