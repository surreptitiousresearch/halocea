...
typedef struct vidPASS_OBJ {
    unsigned __int8  coordSpace; // 0x00 vidPASS_OBJ::COORDSPACE -- boundary enum
    unsigned __int8  skinType;   // 0x01 vidPASS_OBJ::SKINTYPE   -- boundary enum
    unsigned __int8  billboard;  // 0x02 vidPASS_OBJ::BILLBOARD  -- boundary enum
    float            z_bias;     // 0x04
