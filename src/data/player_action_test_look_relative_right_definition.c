/* player_action_test_look_relative_right_definition @ 0x8211B1C4 — hs_function_table entry for the HaloScript "player_action_test_look_relative_right" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82116F28 -> "player_action_test_look_relative_right"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BB20 -> player_control_action_test_look_relative_right_evaluate
...
extern void player_control_action_test_look_relative_right_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition player_action_test_look_relative_right_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "player_action_test_look_relative_right", /* name */
    hs_macro_function_parse,     /* parse */
    player_control_action_test_look_relative_right_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
