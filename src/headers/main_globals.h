...
struct main_globals
{
    __int64           last_time_clocks;              /* 0x000 */
    unsigned int      last_time_msec;                /* 0x008 */
    unsigned char _pad0[4]; /* db-verified padding */
    __int64           last_render_clocks;            /* 0x010 */
    __int64           last_vblank_index;             /* 0x018 */
    __int64           last_initial_vblank_index;     /* 0x020 */
    __int64           last_achievable_vblank_index;  /* 0x028 */
    __int64           last_present_vblank_index;     /* 0x030 */
    unsigned char     did_time_overflow_occur;       /* 0x038 */
    unsigned char _pad1[3]; /* db-verified padding */
    float             seconds_elapsed;               /* 0x03C */
    __int16           connection;                    /* 0x040 */
    unsigned __int16  screenshot_identifier;         /* 0x042 */
    ...
    __int16           switch_to_structure_bsp_index; /* 0x074 */
    ...
    __int16           skip_ticks;                    /* 0x08E */
    __int16           loss_timer;                    /* 0x090 */
    __int16           respawn_timer;                 /* 0x092 */
    ...
    __int16           vblank_interval_current;       /* 0x3C4 */
    __int16           vblank_interval_minimum;       /* 0x3C6 */
    unsigned char     vblank_interval_held;          /* 0x3C8 */
    unsigned char _pad4[1]; /* db-verified padding */
    __int16           vblank_failure_count[6];       /* 0x3CA */
    unsigned char _pad5[2]; /* db-verified padding */
    __int64           vblank_last_failure_time[6];   /* 0x3D8 */
    unsigned int     *vblank_flip_counter;           /* 0x408 */
    __int16           vblank_flip_delta_next_index;  /* 0x40C */
    __int16           vblank_flip_deltas[15];        /* 0x40E */
};
