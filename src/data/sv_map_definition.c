/* sv_map_definition @ 0x8211C840 — hs_function_table entry for the HaloScript "sv_map" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115DC0 -> "sv_map"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E778 -> sv_map_evaluate
 *   +0x10 documentation          = 0x82115D50
...
extern void sv_map_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_map_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_map",                    /* name */
    hs_macro_function_parse,     /* parse */
    sv_map_evaluate,             /* evaluate */
    "<Server Only> Usage: \"sv_map <mapname> <variantname>\" \nAbort current game and playlist and start specified game", /* documentation */
    0,                           /* parameters */
