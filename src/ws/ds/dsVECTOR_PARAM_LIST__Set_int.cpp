...
// dsVECTOR_PARAM_LIST::Set<int> @ 0x823E30B0
// Upsert an int-valued parameter named `id`: overwrite the value of the existing entry with that
// name if present, otherwise append a fresh entry and refresh the dsPARAM_LIST base view.
template<>
void dsVECTOR_PARAM_LIST::Set<int>(dsSTRID id, const int &val)
{
