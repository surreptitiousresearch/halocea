/* build_game_variant_juggernaut @0x8374F2D8 — "Juggernaut" variant: oddball engine (3), ball type
 * "terminator" (the ball carrier is the juggernaut), no teams, 150-tick instant respawn, 10 points to win,
 * weapon set 11, vehicle sets 0x28000000, extra-damage trait while carrying the ball. */
...
game_variant * build_game_variant_juggernaut(game_variant *result)
{
