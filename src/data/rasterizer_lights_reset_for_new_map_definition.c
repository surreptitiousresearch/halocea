/* rasterizer_lights_reset_for_new_map_definition @ 0x8211C214 — hs_function_table entry for the HaloScript "rasterizer_lights_reset_for_new_map" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821163B4 -> "rasterizer_lights_reset_for_new_map"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DA88 -> rasterizer_lights_reset_for_new_map_evaluate
...
extern void rasterizer_lights_reset_for_new_map_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition rasterizer_lights_reset_for_new_map_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "rasterizer_lights_reset_for_new_map", /* name */
    hs_macro_function_parse,     /* parse */
    rasterizer_lights_reset_for_new_map_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
