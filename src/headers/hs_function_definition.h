...
{
    __int16        return_type;                                            /* 0x00 */
    unsigned char  _pad02[2];                                              /* 0x02 */
    char          *name;                                                   /* 0x04 */
    unsigned char  (__fastcall *parse)(__int16, int);                      /* 0x08 */
    void           (__fastcall *evaluate)(__int16, int, unsigned char);    /* 0x0C */
    const char    *documentation;                                          /* 0x10 */
    const char    *parameters;                                             /* 0x14 */
    unsigned char  console_flags;                                          /* 0x18 */
    unsigned char  _pad19[1];                                              /* 0x19 */
    __int16        formal_parameter_count;                                 /* 0x1A */
    __int16        formal_parameters[];                                    /* 0x1C */
