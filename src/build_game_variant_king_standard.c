/* build_game_variant_king_standard @0x8374ACE8 — "standard" (matchmaking-rules) King of the Hill variant:
 * identical to crazy_king_standard but with a stationary hill (ctf.assault = 0). */
...
game_variant * build_game_variant_king_standard(game_variant *result)
{
