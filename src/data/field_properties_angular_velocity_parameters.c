/* field_properties_angular_velocity_parameters @ 0x84183E40 (.data, 796 bytes) — the `parameters` blob for a
 * "smart vector" message-delta field: the quantization envelope [-8.0f, 8.0f] plus separate
 ...
 * DB applied_types: _field_type_smart_vector_parameters field_properties_angular_velocity_parameters;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x000 min_value                              = 0xC1000000 -> -8.0f
 *   +0x004 max_value                              = 0x41000000 -> 8.0f
 ...
 * 0x84184160 are inter-symbol alignment padding, not part of it.
...
_field_type_smart_vector_parameters field_properties_angular_velocity_parameters =
{
    -8.0f,      /* min_value */
    8.0f,       /* max_value */
