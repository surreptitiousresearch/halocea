...
void hud_enable_custom_state_message(__int16 local_player_index, char enabled)
{
    ...
    datum->leave_first_line_blank = ((unsigned __int8)enabled != previous_valid) | leave_first_line_blank;
    if ( enabled )
    {
        datum->state_message.state_message = 0;
