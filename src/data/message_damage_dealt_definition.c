/* message_damage_dealt_definition @ 0x84175D20 (.data, 104 bytes) — the message-delta message definition for
 * `_message_damage_dealt` (id 45): damage has been dealt.
 ...
 *   +0x00 definition_type                    = 0x0000002D -> _message_damage_dealt
 ...
 *   +0x38   field_references[ 1]             = { 0x84183580 -> &field_properties_fixed_width_6bits_definition, offset 4, baseline_offset 4, initialized 0 }
 ...
 * 0x84175D88, i.e. 104 bytes, and 0x28 + (3 + 1) * 16 == 104 — 16 being the DB member stride of
...
_message_definition message_damage_dealt_definition =
{
    _message_damage_dealt,                   /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_fixed_width_6bits_definition, 4, 4, 0 },  /* [ 1] */
