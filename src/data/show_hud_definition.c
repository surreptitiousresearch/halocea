/* show_hud_definition @ 0x8211BB80 — hs_function_table entry for the HaloScript "show_hud" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x8211689C -> "show_hud"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372CCB8 -> scripted_show_hud_evaluate
...
extern void scripted_show_hud_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition show_hud_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "show_hud",                  /* name */
    hs_macro_function_parse,     /* parse */
    scripted_show_hud_evaluate,  /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
