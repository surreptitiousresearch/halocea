/* player_effect_screen_fade_out_evaluate @0x8372BFE0 — HaloScript builtin wrapper for player_effect_screen_fade_out.
 *
...
void player_effect_screen_fade_out_evaluate(int16_t function_index, int thread_index, uint8_t initialize)
{
    ...
    if ( arguments )
    {
        player_effect_screen_fade_out(*(float *)arguments, ((float *)arguments)[1], ((float *)arguments)[2], ((__int16 *)arguments)[6]);
