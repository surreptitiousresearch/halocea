/* field_properties_angular_velocity_definition @ 0x84184160 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "angular_velocity" network field type (_field_type_smart_vector): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_angular_velocity_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x0000001A -> _field_type_smart_vector
 *   +0x04 name[75]      = "angular_velocity" (59 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 *   +0x50 encode        = 0x8379D9F8 -> default_smart_vector_encoder
 *   +0x54 decode        = 0x8379DBF8 -> default_smart_vector_decoder
 *   +0x58 parameters    = 0x84183E40 -> &field_properties_angular_velocity_parameters
...
extern _field_type_smart_vector_parameters field_properties_angular_velocity_parameters; /* 0x84183E40 */

_field_properties_definition field_properties_angular_velocity_definition =
{
    _field_type_smart_vector,                     /* type */
    "angular_velocity",                           /* name[75] */
    { 0 },                                        /* _pad4F */
    default_smart_vector_encoder,                 /* encode */
    default_smart_vector_decoder,                 /* decode */
    &field_properties_angular_velocity_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
