...
{
    pcolor->rgba[0] = (unsigned __int8)(int)((pfcolor->rgba[0] / wtPrimary[0]) * 255.0f);
    pcolor->rgba[1] = (unsigned __int8)(int)((pfcolor->rgba[1] / wtPrimary[1]) * 255.0f);
    ...
    pcolor->rgba[2] = (unsigned __int8)(int)((pfcolor->rgba[2] / wtPrimary[2]) * 255.0f);
}
