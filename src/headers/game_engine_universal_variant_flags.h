 ...
 * DB-verified: types_enum_values 'game_engine_universal_variant_flags' carries these named bit
...
enum game_engine_universal_variant_flags {
	...
	_motion_tracker_no_enemies_bit = 6,
	_game_mode_classic_bit = 7,
	_game_mode_standard_bit = 8,
