/* core_load_at_startup_definition @ 0x8211B824 — hs_function_table entry for the HaloScript "core_load_at_startup" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116AD4 -> "core_load_at_startup"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C578 -> main_load_core_at_startup_evaluate
...
extern void main_load_core_at_startup_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition core_load_at_startup_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "core_load_at_startup",      /* name */
    hs_macro_function_parse,     /* parse */
    main_load_core_at_startup_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
