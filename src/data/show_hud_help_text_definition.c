/* show_hud_help_text_definition @ 0x8211BBA0 — hs_function_table entry for the HaloScript "show_hud_help_text" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82116888 -> "show_hud_help_text"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372CD10 -> scripted_show_hud_help_text_evaluate
...
extern void scripted_show_hud_help_text_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition show_hud_help_text_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "show_hud_help_text",        /* name */
    hs_macro_function_parse,     /* parse */
    scripted_show_hud_help_text_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
