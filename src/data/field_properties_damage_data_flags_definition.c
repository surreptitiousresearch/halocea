/* field_properties_damage_data_flags_definition @ 0x8417C968 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "damage_data_flags" network field type (_field_type_flags): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_damage_data_flags_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x00000011 -> _field_type_flags
 *   +0x04 name[75]      = "damage_data_flags" (58 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 *   +0x50 encode        = 0x8379C118 -> default_flags_encoder
 *   +0x54 decode        = 0x8379C210 -> default_flags_decoder
 *   +0x58 parameters    = 0x8417C940 -> &field_properties_damage_data_flags_parameters
...
extern _field_type_flags_parameters field_properties_damage_data_flags_parameters; /* 0x8417C940 */

_field_properties_definition field_properties_damage_data_flags_definition =
{
    _field_type_flags,                            /* type */
    "damage_data_flags",                          /* name[75] */
    { 0 },                                        /* _pad4F */
    default_flags_encoder,                        /* encode */
    default_flags_decoder,                        /* decode */
    &field_properties_damage_data_flags_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
