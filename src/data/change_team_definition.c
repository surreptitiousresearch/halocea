/* change_team_definition @ 0x8211C574 — hs_function_table entry for the HaloScript "change_team" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116108 -> "change_team"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E228 -> team_change_to_server_evaluate
...
extern void team_change_to_server_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition change_team_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "change_team",               /* name */
    hs_macro_function_parse,     /* parse */
    team_change_to_server_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
