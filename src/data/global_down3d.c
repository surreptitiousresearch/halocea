/* global_down3d @ 0x84176F6C (.data, 4 bytes)
 * DB applied_types: const real_vector3d *global_down3d;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x0000 = 0x82114574 -> "" (empty string at target)
 * data-init pointer (4 bytes) to a {0,0,-1} real_vector3d
