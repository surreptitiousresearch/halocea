...
{
    __int16              convolution_extra_passes;                       /* 0x00 */
    __int16              convolution_type;                               /* 0x02 */
    ...
    unsigned __int8      filter_desaturation_is_additive;                /* 0x20 */
    unsigned __int8      filter_light_enhancement_uses_convolution_mask; /* 0x21 */
    unsigned __int8      filter_desaturation_uses_convolution_mask;      /* 0x22 */
    unsigned __int8      video_on;                                       /* 0x23 */
    __int16              video_overbright_mode;                          /* 0x24 */
