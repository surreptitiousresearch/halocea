/* global_identity4x3 @ 0x84176F7C (.data, 4 bytes)
 * DB applied_types: const real_matrix4x3 *global_identity4x3;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x0000 = 0x82114520 -> private_identity4x3
 * data-init pointer (4 bytes) to the identity
