/* profile_deactivate_definition @ 0x8211B46C — hs_function_table entry for the HaloScript "profile_deactivate" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116D4C -> "profile_deactivate"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BF08 -> profile_sections_deactivate_evaluate
...
extern void profile_sections_deactivate_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition profile_deactivate_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "profile_deactivate",        /* name */
    hs_macro_function_parse,     /* parse */
    profile_sections_deactivate_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
