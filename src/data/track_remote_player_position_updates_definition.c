/* track_remote_player_position_updates_definition @ 0x8211C5CC — hs_function_table entry for the HaloScript "track_remote_player_position_updates" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821160B4 -> "track_remote_player_position_updates"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E2E8 -> console_func_track_remote_player_position_updates_evaluate
...
extern void console_func_track_remote_player_position_updates_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition track_remote_player_position_updates_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "track_remote_player_position_updates", /* name */
    hs_macro_function_parse,     /* parse */
    console_func_track_remote_player_position_updates_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
