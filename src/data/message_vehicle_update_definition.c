/* message_vehicle_update_definition @ 0x8417EC88 (.data, 152 bytes) — the message-delta message definition for
 * `_message_vehicle_update` (id 5): a vehicle's timestamped position, velocities and two orientation vectors.
 * Per-message header set: message_header_game_object_header_timestamped_definition; 6 body fields.
 *
 * Per-field provenance, decoded big-endian straight from the image bytes:
 *   +0x00 definition_type                    = 0x00000005 -> _message_vehicle_update
 ...
 *   +0x1C header_fields                      = 0x84184650 -> &message_header_game_object_header_timestamped_definition
 *   +0x20 body_fields.count                  = 0x00000006 -> 6
 *   +0x24 body_fields.maximum_data_size      = 0xFFFFFFFF -> -1
 *   +0x28   field_references[ 0]             = { 0x84183960 -> &field_properties_boolean_definition, offset 0, baseline_offset 0, initialized 0 }
 ...
 * 0x8417ED20, i.e. 152 bytes, and 0x28 + (6 + 1) * 16 == 152 — 16 being the DB member stride of
...
extern _message_definition_field_reference_set message_header_game_object_header_timestamped_definition;      /* 0x84184650 */
...
_message_definition message_vehicle_update_definition =
{
    _message_vehicle_update,                 /* definition_type */
    ...
    0,                                       /* initialized */
    { 0, 0, 0 },                             /* _pad0 */
    &message_header_game_object_header_timestamped_definition, /* header_fields */
    {                                        /* body_fields */
        6,                                   /* count */
        -1,                                  /* maximum_data_size */
