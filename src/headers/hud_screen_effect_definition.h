...
{
    int              unused1[1];                       /* 0x00 */
    uint16_t mask_flags;                       /* 0x04 */
    uint16_t mask_pad;                         /* 0x06 */
    int              mask_unused[4];                   /* 0x08 */
    tag_reference    mask_fullscreen;                  /* 0x18 */
    tag_reference    mask_splitscreen;                 /* 0x28 */
    int              unused2[2];                       /* 0x38 */
    uint16_t convolution_flags;                /* 0x40 */
    uint16_t convolution_pad;                  /* 0x42 */
    float            convolution_radius_in_bounds[2];  /* 0x44 */
    float            convolution_radius_out_bounds[2]; /* 0x4C */
    int              unused3[6];                        /* 0x54 */
    uint16_t light_enhancement_flags;          /* 0x6C */
    int16_t          light_enhancement_script_source;  /* 0x6E */
    float            light_enhancement_intensity;      /* 0x70 */
    int              unused4[6];                        /* 0x74 */
    uint16_t desaturation_flags;               /* 0x8C */
    int16_t          desaturation_script_source;       /* 0x8E */
