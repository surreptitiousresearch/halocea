/* magic_melee_attack_definition @ 0x82119EA8 — hs_function_table entry for the HaloScript "magic_melee_attack" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117C4C -> "magic_melee_attack"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728D08 -> scripting_magic_melee_attack_evaluate
...
extern void scripting_magic_melee_attack_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition magic_melee_attack_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "magic_melee_attack",        /* name */
    hs_macro_function_parse,     /* parse */
    scripting_magic_melee_attack_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
