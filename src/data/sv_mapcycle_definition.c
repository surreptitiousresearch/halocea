/* sv_mapcycle_definition @ 0x8211C92C — hs_function_table entry for the HaloScript "sv_mapcycle" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115B54 -> "sv_mapcycle"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E970 -> sv_mapcycle_evaluate
 *   +0x10 documentation          = 0x82115B18
...
extern void sv_mapcycle_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_mapcycle_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_mapcycle",               /* name */
    hs_macro_function_parse,     /* parse */
    sv_mapcycle_evaluate,        /* evaluate */
    "Print the contents of the currently loaded mapcycle file", /* documentation */
    0,                           /* parameters */
