/* attract_mode_start_definition @ 0x8211B6B8 — hs_function_table entry for the HaloScript "attract_mode_start" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116BB0 -> "attract_mode_start"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C278 -> attract_mode_start_evaluate
...
extern void attract_mode_start_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition attract_mode_start_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "attract_mode_start",        /* name */
    hs_macro_function_parse,     /* parse */
    attract_mode_start_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
