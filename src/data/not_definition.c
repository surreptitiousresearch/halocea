...
extern void hs_not_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition not_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "not",                       /* name */
    hs_macro_function_parse,     /* parse */
    hs_not_evaluate,             /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
