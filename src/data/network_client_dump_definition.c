/* network_client_dump_definition @ 0x8211BD6C — hs_function_table entry for the HaloScript "network_client_dump" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116724 -> "network_client_dump"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D0F0 -> global_network_game_client_dump_evaluate
...
extern void global_network_game_client_dump_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition network_client_dump_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "network_client_dump",       /* name */
    hs_macro_function_parse,     /* parse */
    global_network_game_client_dump_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
