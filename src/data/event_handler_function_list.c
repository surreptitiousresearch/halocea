...
extern uint8_t network_game_server_list_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t network_game_start_new_server(widget_instance *widget, event_record *event, uint8_t *widget_deleted);
extern uint8_t network_server_list_dispose(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
...
extern uint8_t split_screen_game_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t coop_game_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t main_menu_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t multiplayer_type_menu_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t multiplayer_pick_quick_start_play_stage(widget_instance *widget, event_record *event, uint8_t *widget_deleted);
extern uint8_t multiplayer_level_list_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t multiplayer_level_list_dispose(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t multiplayer_level_select(widget_instance *wrapper_widget, event_record *event, uint8_t *widget_deleted);
extern uint8_t multiplayer_profiles_list_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t multiplayer_profiles_list_dispose(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
...
extern uint8_t player_profiles_list_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t player_profiles_list_dispose(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
...
extern uint8_t player_profile_color_picker_menu_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
extern uint8_t player_profile_color_picker_menu_dispose(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
...
extern uint8_t cancel_profile_delete(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
...
extern uint8_t difficulty_menu_initialize(widget_instance *widget, event_record *event, unsigned char *widget_deleted);
