/* render_effects_definition @ 0x82119AF8 — hs_function_table entry for the HaloScript "render_effects" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117EC8 -> "render_effects"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728420 -> render_effects_evaluate
...
extern void render_effects_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition render_effects_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "render_effects",            /* name */
    hs_macro_function_parse,     /* parse */
    render_effects_evaluate,     /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
