/* cheat_spawn_warthog_definition @ 0x8211A258 — hs_function_table entry for the HaloScript "cheat_spawn_warthog" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117960 -> "cheat_spawn_warthog"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729628 -> cheat_spawn_warthog_evaluate
...
extern void cheat_spawn_warthog_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition cheat_spawn_warthog_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "cheat_spawn_warthog",       /* name */
    hs_macro_function_parse,     /* parse */
    cheat_spawn_warthog_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
