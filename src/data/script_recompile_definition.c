/* script_recompile_definition @ 0x821196A4 — hs_function_table entry for the HaloScript "script_recompile" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821181E8 -> "script_recompile"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372FF18 -> hs_recompile_evaluate
...
extern void hs_recompile_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition script_recompile_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "script_recompile",          /* name */
    hs_macro_function_parse,     /* parse */
    hs_recompile_evaluate,       /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
