/* profile_load_definition @ 0x8211C6A0 — hs_function_table entry for the HaloScript "profile_load" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82114E18 -> "profile_load"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E450 -> player_profile_load_builtin_profiles_evaluate
 *   +0x10 documentation          = 0x82115FB0
...
extern void player_profile_load_builtin_profiles_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition profile_load_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "profile_load",              /* name */
    hs_macro_function_parse,     /* parse */
    player_profile_load_builtin_profiles_evaluate, /* evaluate */
    "Load any included builtin profiles and create profiles on disk.", /* documentation */
    0,                           /* parameters */
