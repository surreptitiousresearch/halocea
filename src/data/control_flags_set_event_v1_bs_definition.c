...
static int control_flags_set_event_v1_bs_codes[] = { _begin_bs_array, 1 /* array element count */, _2byte, _end_bs_array };

byte_swap_definition control_flags_set_event_v1_bs_definition =
{
    "control_flags_set_event_v1",                       /* name */
    6,                                        /* size */
    control_flags_set_event_v1_bs_codes,                /* codes */
