#pragma once
/* GPUTEXTUREFORMAT — Xenos (Xbox 360 GPU) hardware texture-format enum: the 6-bit DataFormat
 * field of a GPUTEXTURE_FETCH_CONSTANT. External XDK enum; DB-verified (types_enum_values
 * GPUTEXTUREFORMAT, all 64 members). */
