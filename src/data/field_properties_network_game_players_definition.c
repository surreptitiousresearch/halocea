/* field_properties_network_game_players_definition @ 0x84181950 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "network_game_players" network field type (_field_type_array): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_network_game_players_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x00000008 -> _field_type_array
 *   +0x04 name[75]      = "network_game_players" (55 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 *   +0x50 encode        = 0x8379AF80 -> default_array_encoder
 *   +0x54 decode        = 0x8379B0E8 -> default_array_decoder
 *   +0x58 parameters    = 0x84181874 -> &field_properties_network_game_players_parameters
...
extern _field_type_array_parameters field_properties_network_game_players_parameters; /* 0x84181874 */

_field_properties_definition field_properties_network_game_players_definition =
{
    _field_type_array,                            /* type */
    "network_game_players",                       /* name[75] */
    { 0 },                                        /* _pad4F */
    default_array_encoder,                        /* encode */
    default_array_decoder,                        /* decode */
    &field_properties_network_game_players_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
