/* weapon_index_set_event_v1_bs_definition @ 0x841850D0 (.data, 20 bytes)
 * DB applied_types: byte_swap_definition weapon_index_set_event_v1_bs_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 name                       = 0x82128A94 -> "weapon_index_set_event_v1"
 *   +0x04 size                       = 0x00000006
 *   +0x08 codes                      = 0x841850C0 -> weapon_index_set_event_v1_bs_codes
...
{
    "weapon_index_set_event_v1",                       /* name */
    6,                                        /* size */
    weapon_index_set_event_v1_bs_codes,                /* codes */
