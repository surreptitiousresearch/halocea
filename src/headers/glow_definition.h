...
typedef struct glow_definition
{
    ...
    __int16           number_of_particles;                                  /* 0x20 */
    __int16           boundary_effect;                                      /* 0x22 */
    __int16           normal_particle_distribution;                        /* 0x24 */
    __int16           trailing_particle_distribution;                      /* 0x26 */
    unsigned int      flags;                                                /* 0x28 */
    int               unused0[7];                                          /* 0x2C */
    __int16           render_mode;                                          /* 0x48 */
    __int16           render_orientation;                                   /* 0x4A */
    int               render_flags;                                        /* 0x4C */
    __int16           particle_rotational_velocity_attachment_index;       /* 0x50 */
    unsigned __int16  uw0;                                                  /* 0x52 */
    ...
    __int16           effect_rotational_velocity_attachment_index;         /* 0x60 */
    unsigned __int16  uw1;                                                  /* 0x62 */
    ...
    __int16           effect_translational_velocity_attachment_index;      /* 0x70 */
    unsigned __int16  uw2;                                                  /* 0x72 */
    ...
    __int16           distance_to_object_attachment_index;                  /* 0x80 */
    unsigned __int16  uw3;                                                  /* 0x82 */
    ...
    int               unused2[2];                                          /* 0x94 */
    __int16           particle_size_attachment_index;                       /* 0x9C */
    unsigned __int16  uw4;                                                  /* 0x9E */
    ...
    __int16           color_attachment_index;                               /* 0xB0 */
    unsigned __int16  uw5;                                                  /* 0xB2 */
