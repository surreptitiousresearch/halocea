/* hud_activate_nav_point_with_game_engine_flag @0x837ED078 — tail-call forwarder (`extsh r6, r5; li r5, 2;
 * b hud_activate_nav_point`; confirmed via disasm, not a bare blr). Forwards with type=2 (game-engine-flag
...
void hud_activate_nav_point_with_game_engine_flag(int16_t nav_index, int player_index, int16_t flag_index, float vertical_offset)
{
