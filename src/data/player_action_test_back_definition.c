/* player_action_test_back_definition @ 0x8211B154 — hs_function_table entry for the HaloScript "player_action_test_back" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82116FC4 -> "player_action_test_back"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BA00 -> player_control_action_test_back_evaluate
...
extern void player_control_action_test_back_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition player_action_test_back_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "player_action_test_back",   /* name */
    hs_macro_function_parse,     /* parse */
    player_control_action_test_back_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
