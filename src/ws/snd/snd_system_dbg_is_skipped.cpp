 ...
 *   0x836B9F38 lis  r11, ?SystemFMod@snd@@3PAVSYSTEM_FMOD@1@A@ha    ; &snd::SystemFMod (ptr global @0x8432801C)
...
namespace snd {
// ?SystemFMod@snd@@3PAVSYSTEM_FMOD@1@A @0x8432801C — the FMOD sound-driver singleton (boundary global).
