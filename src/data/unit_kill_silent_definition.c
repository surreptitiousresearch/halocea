/* unit_kill_silent_definition @ 0x82119B98 — hs_function_table entry for the HaloScript "unit_kill_silent" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117E80 -> "unit_kill_silent"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728558 -> unit_kill_silent_evaluate
...
extern void unit_kill_silent_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition unit_kill_silent_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "unit_kill_silent",          /* name */
    hs_macro_function_parse,     /* parse */
    unit_kill_silent_evaluate,   /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
