/* actor_unit_control_secondary_trigger @0x8371FC78 — set/clear the secondary-fire bit (0x1000) in the
...
void actor_unit_control_secondary_trigger(int actor_index, uint8_t trigger)
{
