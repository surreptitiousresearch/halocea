...
// dsVECTOR<instCONSTRUCTOR_NODE*,8>::PushBack @ 0x826E22B8
...
template<>
instCONSTRUCTOR_NODE *&dsVECTOR<instCONSTRUCTOR_NODE *, 8>::PushBack(instCONSTRUCTOR_NODE *const &val)
{
    if (this->allocated >= this->nElem + 1) {
        ...
        instCONSTRUCTOR_NODE *saved = val;
