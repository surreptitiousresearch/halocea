/* input_find_default_definition @ 0x8211C454 — hs_function_table entry for the HaloScript "input_find_default" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116184 -> "input_find_default"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DF80 -> test_input_device_defaults_find_evaluate
...
extern void test_input_device_defaults_find_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition input_find_default_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "input_find_default",        /* name */
    hs_macro_function_parse,     /* parse */
    test_input_device_defaults_find_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
