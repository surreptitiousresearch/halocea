...
void _rasterizer_environment_diffuse_lights_begin(void)
{
    ...
    if ( (global_d3d_caps.TextureAddressCaps & 8) != 0 )
    {
        ...
        D3DDevice_SetSamplerState_AddressU_Inline(global_d3d_device, 2, 6);
        D3DDevice_SetSamplerState_AddressV_Inline(global_d3d_device, 2, 6);
        D3DDevice_SetSamplerState_AddressW_Inline(global_d3d_device, 2, 6);
    }
    else
    {
    ...
    D3DDevice_SetSamplerState_MinFilter(global_d3d_device, 3, 0);
