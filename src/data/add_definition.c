...
const hs_function_definition add_definition =
{
    ...
    "returns the sum of all specified expressions.", /* documentation */
    "<number(s)>",               /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
