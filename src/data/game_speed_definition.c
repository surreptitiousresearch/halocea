/* game_speed_definition @ 0x8211C78C — hs_function_table entry for the HaloScript "game_speed" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115F18 -> "game_speed"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E5F8 -> game_time_set_speed_evaluate
...
extern void game_time_set_speed_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition game_speed_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "game_speed",                /* name */
    hs_macro_function_parse,     /* parse */
    game_time_set_speed_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
