/* director_save_camera_evaluate @0x8372B5C0 — HaloScript builtin evaluator. Takes no arguments; invokes the engine routine
 * and returns void.
 *
 * DEVIATION: the decompiler shows the engine call with three leftover-register arguments; director_save_camera actually
