/* D3DDevice_SetStreamSource_Inline_6 @0x83D14758 */
...
void D3DDevice_SetStreamSource_Inline_6(D3DDevice *pDevice, unsigned int StreamNumber, D3DVertexBuffer *pStreamData, unsigned int OffsetInBytes, unsigned int Stride)
{
