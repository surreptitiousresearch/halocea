/* list_count_definition @ 0x82119558 — hs_function_table entry for the HaloScript "list_count" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0007 -> hs_type_short_integer
 *   +0x04 name                   = 0x821182B0 -> "list_count"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x837276E0 -> object_list_count_evaluate
...
extern void object_list_count_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition list_count_definition =
{
    hs_type_short_integer,       /* return_type */
    { 0, 0 },                    /* _pad02 */
    "list_count",                /* name */
    hs_macro_function_parse,     /* parse */
    object_list_count_evaluate,  /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
