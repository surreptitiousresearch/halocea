/* vehicle_gunner_definition @ 0x82119F04 — hs_function_table entry for the HaloScript "vehicle_gunner" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0026 -> hs_type_unit
 *   +0x04 name                   = 0x82117C1C -> "vehicle_gunner"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728DD0 -> unit_scripting_unit_gunner_evaluate
...
extern void unit_scripting_unit_gunner_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition vehicle_gunner_definition =
{
    hs_type_unit,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "vehicle_gunner",            /* name */
    hs_macro_function_parse,     /* parse */
    unit_scripting_unit_gunner_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
