/* profile_service_dump_timers_definition @ 0x8211B258 — hs_function_table entry for the HaloScript "profile_service_dump_timers" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116E74 -> "profile_service_dump_timers"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BC58 -> ProfileServiceDumpTimers_evaluate
...
extern void ProfileServiceDumpTimers_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition profile_service_dump_timers_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "profile_service_dump_timers", /* name */
    hs_macro_function_parse,     /* parse */
    ProfileServiceDumpTimers_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
