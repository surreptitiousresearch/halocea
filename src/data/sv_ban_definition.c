/* sv_ban_definition @ 0x8211C8B8 — hs_function_table entry for the HaloScript "sv_ban" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115C6C -> "sv_ban"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E880 -> sv_ban_evaluate
 *   +0x10 documentation          = 0x82115C10
...
extern void sv_ban_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_ban_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_ban",                    /* name */
    hs_macro_function_parse,     /* parse */
    sv_ban_evaluate,             /* evaluate */
    "<Server Only> Usage: sv_ban <player # or name> \nPlayer is kicked and added to banned.txt.", /* documentation */
    0,                           /* parameters */
