...
typedef struct lightning_definition
{
    ...
    __int16          count;                   /* 0x02 — number of overlaid bolt instances */
    int              unused1[4];              /* 0x04 */
    float            near_fade_distance;      /* 0x14 */
    float            far_fade_distance;       /* 0x18 */
    int              unused2[4];              /* 0x1C */
    __int16          jitter_scale_source;     /* 0x2C — animation value index (1..4) for midpoint jitter */
    __int16          thickness_scale_source;  /* 0x2E — animation value index for bolt width */
    __int16          tint_modulation_source;  /* 0x30 — animation color index for tint */
    __int16          brightness_scale_source; /* 0x32 — animation value index for brightness */
