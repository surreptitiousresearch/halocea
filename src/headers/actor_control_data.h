...
typedef struct actor_control_data
{
    ...
    unsigned __int8  moving;                                            /* 0x098 */
    unsigned __int8  moving_forced_by_aiming;                           /* 0x099 */
    unsigned __int8  movement_complete;                                 /* 0x09A */
    unsigned __int8  movement_thwarted;                                 /* 0x09B */
    unsigned __int8  crouching;                                         /* 0x09C */
    unsigned char    _pad09D;                                           /* 0x09D */
    __int16          moving_facing_direction;                           /* 0x09E */
    ...
    unsigned __int8  jumping_targeted;                                  /* 0x0C4 */
    ...
    __int16          secondary_look_type;                               /* 0x0D8 */
    __int16          secondary_look_priority;                           /* 0x0DA */
    __int16          secondary_look_timer;                              /* 0x0DC */
    unsigned char    _pad0DE[2];                                        /* 0x0DE */
    direction_specification secondary_look_direction;                  /* 0x0E0 */
    unsigned __int8  idle_major_active;                                 /* 0x0F0 */
    unsigned __int8  idle_major_is_aiming;                              /* 0x0F1 */
    unsigned __int8  idle_major_direction_is_interesting;               /* 0x0F2 */
    unsigned __int8  idle_minor_active;                                 /* 0x0F3 */
    ...
    unsigned __int8  aiming_away_from_primary;                          /* 0x120 */
    unsigned __int8  free_facing_vector;                                /* 0x121 */
    unsigned __int8  optional_facing_vector;                            /* 0x122 */
    unsigned __int8  desire_stationary_facing;                          /* 0x123 */
    unsigned __int8  fixed_stationary_facing;                           /* 0x124 */
    unsigned __int8  face_exactly;                                      /* 0x125 */
    ...
    unsigned __int8  vector_avoidance_clear_times[8][2];                /* 0x15C */
    __int16          vector_avoidance_current_direction;                /* 0x16C */
    ...
    __int16          vector_avoidance_sharp_turn_timer;                 /* 0x184 */
    __int16          fire_state;                                       /* 0x186 */
    __int16          fire_state_timer;                                 /* 0x188 */
    __int16          burst_disable_timer;                               /* 0x18A */
    __int16          trigger_delay_timer;                               /* 0x18C */
    __int16          blocked_communication_timer;                       /* 0x18E */
    __int16          special_fire_delay;                                /* 0x190 */
    __int16          special_fire_deny_attempts;                        /* 0x192 */
    unsigned __int8  firing_at_new_target;                              /* 0x194 */
    unsigned __int8  firing_while_moving;                               /* 0x195 */
    unsigned __int8  overcharging_weapon;                               /* 0x196 */
    unsigned __int8  fire_burst_secondary;                              /* 0x197 */
    unsigned __int8  next_burst_secondary;                              /* 0x198 */
    unsigned char    _pad199[3];                                        /* 0x199 */
    float            weapon_maximum_range;                              /* 0x19C */
    __int16          current_fire_target_type;                         /* 0x1A0 */
    ...
    unsigned __int8  current_fire_target_visible;                      /* 0x1B4 */
    unsigned __int8  current_fire_target_underwater;                   /* 0x1B5 */
    unsigned __int8  current_fire_target_superballistic;               /* 0x1B6 */
    unsigned __int8  current_fire_target_bombardment;                  /* 0x1B7 */
    unsigned __int8  current_fire_target_outside_active_area;          /* 0x1B8 */
    unsigned char    _pad1B9;                                           /* 0x1B9 */
    __int16          current_fire_target_line_of_sight;                /* 0x1BA */
    unsigned __int8  aiming_at_fire_target;                             /* 0x1BC */
    ...
    unsigned __int8  burst_aim_by_vector;                               /* 0x21C */
    ...
    unsigned __int8  grenade_trying_to_throw;                          /* 0x234 */
    unsigned __int8  grenade_current_lob;                               /* 0x235 */
    ...
    unsigned __int8  idle_vocalization_combat;                          /* 0x260 */
    unsigned char    _pad261;                                           /* 0x261 */
    __int16          idle_vocalization_timer;                          /* 0x262 */
