/* profile_activate_definition @ 0x8211B44C — hs_function_table entry for the HaloScript "profile_activate" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116D60 -> "profile_activate"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BEF8 -> profile_sections_activate_evaluate
...
extern void profile_sections_activate_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition profile_activate_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "profile_activate",          /* name */
    hs_macro_function_parse,     /* parse */
    profile_sections_activate_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
