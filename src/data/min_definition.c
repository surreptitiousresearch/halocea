...
const hs_function_definition min_definition =
{
    ...
    "returns the minimum of all specified expressions.", /* documentation */
    "<number(s)>",               /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
