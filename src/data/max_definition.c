...
const hs_function_definition max_definition =
{
    ...
    "returns the maximum of all specified expressions.", /* documentation */
    "<number(s)>",               /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
