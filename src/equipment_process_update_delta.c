...
extern uint8_t message_delta_processor_decode_incremental(void *destination_data,
        const void *baseline_data, const message_delta_processor_header *header, uint8_t allow_empty_body);
