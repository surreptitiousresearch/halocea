/* actor_action_handle_berserking_from_damage @0x837F222C — transitions into berserking when a pending
...
uint8_t actor_action_handle_berserking_from_damage(uint16_t actor_index)
{
