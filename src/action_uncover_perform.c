...
uint8_t action_uncover_perform(int actor_index)
{
    ...
    int16_t change_result = actor_change_firing_position(actor_index, firing_position_index, &best_firing_position,
