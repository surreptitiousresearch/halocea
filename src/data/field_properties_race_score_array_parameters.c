/* field_properties_race_score_array_parameters @ 0x841869F4 (.data, 12 bytes) — the `parameters` blob for an
 ...
 * DB applied_types: _field_type_array_parameters field_properties_race_score_array_parameters;
...
_field_type_array_parameters field_properties_race_score_array_parameters =
{
    16,                                     /* count */
