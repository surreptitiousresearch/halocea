/* scenery_get_animation_time_definition @ 0x82119A90 — hs_function_table entry for the HaloScript "scenery_get_animation_time" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0007 -> hs_type_short_integer
 *   +0x04 name                   = 0x82117F14 -> "scenery_get_animation_time"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728320 -> scenery_get_animation_time_evaluate
 *   +0x10 documentation          = 0x8200155A
 *   +0x14 parameters             = 0x00000000 (NULL)
 *   +0x18 console_flags          = 0x00
 *   +0x1A formal_parameter_count = 1  (+0x1C formal_parameters = hs_type_scenery)
 */
...
extern void scenery_get_animation_time_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition scenery_get_animation_time_definition =
{
    hs_type_short_integer,       /* return_type */
    { 0, 0 },                    /* _pad02 */
    "scenery_get_animation_time", /* name */
    hs_macro_function_parse,     /* parse */
    scenery_get_animation_time_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
    1,                           /* formal_parameter_count */
    { hs_type_scenery },  /* formal_parameters */
};
