// FUNCTION_INDEX entry: dsVECTOR<...ERASED,8>::Front @0x8252A2A8 (?Front@?$dsVECTOR@UERASED@?$dsERASE_MANAGER@VLINE_ERASER@?$dsLF_SORTED_MAP@PBDVdsSTRID@@UdsSTR_HASH@@VdsSTR_CMP@@@@@@$07@@QAAAAUERASED@?$dsERASE_MANAGER@VLINE_ERASER@?$dsLF_SORTED_MAP@PBDVdsSTRID@@UdsSTR_HASH@@VdsSTR_CMP@@@@@@XZ)
#include "dsVECTOR.h"
