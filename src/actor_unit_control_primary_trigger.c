/* actor_unit_control_primary_trigger @0x8371FC38 — set/clear the primary-fire bit (0x800, bit 0xB) in the
...
void actor_unit_control_primary_trigger(int actor_index, uint8_t trigger,
                                        float analog_value)
{
