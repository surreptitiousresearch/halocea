/* global_real_argb_magenta @ 0x84176D7C (.data, 4 bytes)  DB decl: const real_argb_color *global_real_argb_magenta;
 * Image bytes (big-endian), reconstructed from the binary .data record:
 *   +0x0000 = 0x82113F88 -> &private_real_argb_colors[8]   (0x82113F08 + 16*8)
 *
 * That element decodes to { alpha 1.0, red 1.0, green 0.0, blue 1.0 } = magenta.
