/* vehicle_riders_definition @ 0x82119EC4 — hs_function_table entry for the HaloScript "vehicle_riders" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0017 -> hs_type_object_list
 *   +0x04 name                   = 0x82117C3C -> "vehicle_riders"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728D40 -> unit_scripting_unit_riders_evaluate
...
extern void unit_scripting_unit_riders_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition vehicle_riders_definition =
{
    hs_type_object_list,         /* return_type */
    { 0, 0 },                    /* _pad02 */
    "vehicle_riders",            /* name */
    hs_macro_function_parse,     /* parse */
    unit_scripting_unit_riders_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
