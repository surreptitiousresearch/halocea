/* ?cbGetCurCheckpoint@SSL_EXPORTER_haloENGINE_CONTROL@@SAXVsslOBJ_REF@@HPAVdsDATA@@AAV3@0@Z @0x823C4DF8 */
...
void SSL_EXPORTER_haloENGINE_CONTROL::cbGetCurCheckpoint(sslOBJ_REF self, int argc, dsDATA *argv, dsDATA *retVal, sslOBJ_REF caller)
{
    static ds_data_call::HandlerBase_haloENGINE_CONTROL *method =
        ds_data_call::CreateHandler<haloENGINE_CONTROL, haloENGINE_CONTROL, const dsTSTRING<char> &>(&haloENGINE_CONTROL::GetCurCheckpoint);
