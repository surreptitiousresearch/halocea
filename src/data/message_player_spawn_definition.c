/* message_player_spawn_definition @ 0x84175AE8 (.data, 248 bytes) — the message-delta message definition for
 * `_message_player_spawn` (id 8): a player has spawned, with the objects the spawn created.
 ...
 *   +0x00 definition_type                    = 0x00000008 -> _message_player_spawn
 ...
 *   +0x48   field_references[ 2]             = { 0x841833D0 -> &field_properties_integer_large_definition, offset 8, baseline_offset 8, initialized 0 }
 *   +0x58   field_references[ 3]             = { 0x84183A30 -> &field_properties_object_index_definition, offset 12, baseline_offset 12, initialized 0 }
 *   +0x68   field_references[ 4]             = { 0x84183338 -> &field_properties_integer_medium_definition, offset 16, baseline_offset 16, initialized 0 }
 ...
 *   +0xB8   field_references[ 9]             = { 0x84183338 -> &field_properties_integer_medium_definition, offset 36, baseline_offset 36, initialized 0 }
 *   +0xC8   field_references[10]             = { 0x84183338 -> &field_properties_integer_medium_definition, offset 38, baseline_offset 38, initialized 0 }
 *   +0xD8   field_references[11]             = { 0x84183338 -> &field_properties_integer_medium_definition, offset 40, baseline_offset 40, initialized 0 }
 ...
 * 0x84175BE0, i.e. 248 bytes, and 0x28 + (12 + 1) * 16 == 248 — 16 being the DB member stride of
...
_message_definition message_player_spawn_definition =
{
    _message_player_spawn,                   /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_integer_large_definition, 8, 8, 0 },     /* [ 2] */
            { &field_properties_object_index_definition, 12, 12, 0 },    /* [ 3] */
            { &field_properties_integer_medium_definition, 16, 16, 0 },  /* [ 4] */
            ...
            { &field_properties_integer_medium_definition, 36, 36, 0 },  /* [ 9] */
            { &field_properties_integer_medium_definition, 38, 38, 0 },  /* [10] */
            { &field_properties_integer_medium_definition, 40, 40, 0 },  /* [11] */
