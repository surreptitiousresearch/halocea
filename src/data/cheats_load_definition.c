/* cheats_load_definition @ 0x8211A2CC — hs_function_table entry for the HaloScript "cheats_load" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821178F8 -> "cheats_load"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729718 -> cheats_load_evaluate
...
extern void cheats_load_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition cheats_load_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "cheats_load",               /* name */
    hs_macro_function_parse,     /* parse */
    cheats_load_evaluate,        /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
