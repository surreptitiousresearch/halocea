/* game_skip_ticks_definition @ 0x8211B8A0 — hs_function_table entry for the HaloScript "game_skip_ticks" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116A88 -> "game_skip_ticks"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C688 -> main_skip_evaluate
...
extern void main_skip_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition game_skip_ticks_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "game_skip_ticks",           /* name */
    hs_macro_function_parse,     /* parse */
    main_skip_evaluate,          /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
