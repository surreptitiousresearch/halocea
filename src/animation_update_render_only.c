...
int16_t animation_update_render_only(int animation_graph_index, animation_state *state, int *triggered_sound_index)
{
    return animation_update_internal(animation_update_kind_render_only,
