/* help_definition @ 0x8211C6C0 — hs_function_table entry for the HaloScript "help" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115FA8 -> "help"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83730368 -> hs_help_evaluate
 *   +0x10 documentation          = 0x82115F7C
...
extern void hs_help_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition help_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "help",                      /* name */
    hs_macro_function_parse,     /* parse */
    hs_help_evaluate,            /* evaluate */
    "prints a description of the named function.", /* documentation */
    0,                           /* parameters */
