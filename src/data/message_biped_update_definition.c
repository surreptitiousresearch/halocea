/* message_biped_update_definition @ 0x841848E0 (.data, 120 bytes) — the message-delta message definition for
 * `_message_biped_update` (id 4): a biped's grenade counts, weapon/grenade selection and one boolean.
 * Per-message header set: message_header_biped_update_header_definition; 4 body fields.
 *
 * Per-field provenance, decoded big-endian straight from the image bytes:
 *   +0x00 definition_type                    = 0x00000004 -> _message_biped_update
 ...
 *   +0x1C header_fields                      = 0x84184878 -> &message_header_biped_update_header_definition
 *   +0x20 body_fields.count                  = 0x00000004 -> 4
 *   +0x24 body_fields.maximum_data_size      = 0xFFFFFFFF -> -1
 *   +0x28   field_references[ 0]             = { 0x841834A0 -> &field_properties_grenade_counts_definition, offset 0, baseline_offset 0, initialized 0 }
 *   +0x38   field_references[ 1]             = { 0x84183510 -> &field_properties_fixed_width_3bits_definition, offset 4, baseline_offset 4, initialized 0 }
 *   +0x48   field_references[ 2]             = { 0x84183580 -> &field_properties_fixed_width_6bits_definition, offset 8, baseline_offset 8, initialized 0 }
 *   +0x58   field_references[ 3]             = { 0x84183960 -> &field_properties_boolean_definition, offset 12, baseline_offset 12, initialized 0 }
 ...
 * 0x84184958, i.e. 120 bytes, and 0x28 + (4 + 1) * 16 == 120 — 16 being the DB member stride of
...
extern _message_definition_field_reference_set message_header_biped_update_header_definition;                 /* 0x84184878 */
...
_message_definition message_biped_update_definition =
{
    _message_biped_update,                   /* definition_type */
    ...
    0,                                       /* initialized */
    { 0, 0, 0 },                             /* _pad0 */
    &message_header_biped_update_header_definition, /* header_fields */
    {                                        /* body_fields */
        4,                                   /* count */
        -1,                                  /* maximum_data_size */
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            { &field_properties_grenade_counts_definition, 0, 0, 0 },     /* [ 0] */
            { &field_properties_fixed_width_3bits_definition, 4, 4, 0 },  /* [ 1] */
            { &field_properties_fixed_width_6bits_definition, 8, 8, 0 },  /* [ 2] */
            { &field_properties_boolean_definition, 12, 12, 0 },          /* [ 3] */
