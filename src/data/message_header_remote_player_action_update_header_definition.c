/* message_header_remote_player_action_update_header_definition @ 0x8417DF48 (.data, 72 bytes) — the shared per-message HEADER
 * field-reference set "remote_player_action_update_header": the fields every message carrying this header serializes ahead
 ...
 * DB applied_types: _message_definition_field_reference_set message_header_remote_player_action_update_header_definition;
 ...
 *   +0x028   [ 2] = { 0x84183190 -> &field_properties_remote_player_action_update_baseline_id_definition, offset 5, baseline_offset 5, initialized 0 }
...
extern _field_properties_definition field_properties_remote_player_action_update_baseline_id_definition; /* 0x84183190 */
extern _field_properties_definition field_properties_update_id_definition; /* 0x84183268 */

_message_definition_field_reference_set message_header_remote_player_action_update_header_definition =
{
    3,                                       /* count */
    -1,                                      /* maximum_data_size */
    {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
        ...
        { &field_properties_remote_player_action_update_baseline_id_definition, 5, 5, 0 },  /* [ 2] */
