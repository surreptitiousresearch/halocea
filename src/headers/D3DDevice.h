...
typedef struct D3DDevice {
    ...
    void (__fastcall *m_SetRenderStateCall[101])(struct D3DDevice *, unsigned int);  /* 0x40 */
    void (__fastcall *m_SetSamplerStateCall[20])(struct D3DDevice *, unsigned int, unsigned int); /* 0x1D4 */
    unsigned int (__fastcall *m_GetRenderStateCall[101])(struct D3DDevice *);        /* 0x224 */
    unsigned int (__fastcall *m_GetSamplerStateCall[20])(struct D3DDevice *, unsigned int); /* 0x3B8 */
