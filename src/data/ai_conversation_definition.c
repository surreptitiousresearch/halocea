/* ai_conversation_definition @ 0x8211AE28 — hs_function_table entry for the HaloScript "ai_conversation" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82117220 -> "ai_conversation"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372B250 -> ai_scripting_conversation_evaluate
...
extern void ai_scripting_conversation_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_conversation_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_conversation",           /* name */
    hs_macro_function_parse,     /* parse */
    ai_scripting_conversation_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
