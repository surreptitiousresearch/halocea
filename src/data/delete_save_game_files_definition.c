/* delete_save_game_files_definition @ 0x8211C340 — hs_function_table entry for the HaloScript "delete_save_game_files" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116270 -> "delete_save_game_files"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DD38 -> saved_game_files_delete_all_custom_profiles_evaluate
...
extern void saved_game_files_delete_all_custom_profiles_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition delete_save_game_files_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "delete_save_game_files",    /* name */
    hs_macro_function_parse,     /* parse */
    saved_game_files_delete_all_custom_profiles_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
