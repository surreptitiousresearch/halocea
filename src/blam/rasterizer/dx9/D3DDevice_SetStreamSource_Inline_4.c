/* D3DDevice_SetStreamSource_Inline_4 @0x83723C98 */
...
void D3DDevice_SetStreamSource_Inline_4(D3DDevice *pDevice, unsigned int StreamNumber, D3DVertexBuffer *pStreamData, unsigned int OffsetInBytes, unsigned int Stride)
{
