// FUNCTION_INDEX entry: ds_data::dsDATA_TYPE_IMPL<haloPLAYER_ACTIONS_ENV>::Load @0x823BEE80 (?Load@?$dsDATA_TYPE_IMPL@UhaloPLAYER_ACTIONS_ENV@@@ds_data@@UBAHPAVfioFILE@@PAK@Z)
