/* message_vehicle_new_definition @ 0x8417EB60 (.data, 296 bytes) — the message-delta message definition for
 * `_message_vehicle_new` (id 27): a new vehicle has been created.
 ...
 *   +0x00 definition_type                    = 0x0000001B -> _message_vehicle_new
 ...
 *   +0x78   field_references[ 5]             = { 0x84183A30 -> &field_properties_object_index_definition, offset 20, baseline_offset 20, initialized 0 }
 *   +0x88   field_references[ 6]             = { 0x84183A30 -> &field_properties_object_index_definition, offset 24, baseline_offset 24, initialized 0 }
 *   +0x98   field_references[ 7]             = { 0x84183A30 -> &field_properties_object_index_definition, offset 28, baseline_offset 28, initialized 0 }
 *   +0xA8   field_references[ 8]             = { 0x84183A30 -> &field_properties_object_index_definition, offset 32, baseline_offset 32, initialized 0 }
 *   +0xB8   field_references[ 9]             = { 0x841832D0 -> &field_properties_integer_small_definition, offset 96, baseline_offset 96, initialized 0 }
 *   +0xC8   field_references[10]             = { 0x84183C08 -> &field_properties_point3d_definition, offset 36, baseline_offset 36, initialized 0 }
 *   +0xD8   field_references[11]             = { 0x841836E0 -> &field_properties_fixed_width_normal_8bit_definition, offset 48, baseline_offset 48, initialized 0 }
 *   +0xE8   field_references[12]             = { 0x841836E0 -> &field_properties_fixed_width_normal_8bit_definition, offset 60, baseline_offset 60, initialized 0 }
 *   +0xF8   field_references[13]             = { 0x841844E8 -> &field_properties_translational_velocity_definition, offset 72, baseline_offset 72, initialized 0 }
 *   +0x108   field_references[14]             = { 0x84184160 -> &field_properties_angular_velocity_definition, offset 84, baseline_offset 84, initialized 0 }
 ...
 * 0x8417EC88, i.e. 296 bytes, and 0x28 + (15 + 1) * 16 == 296 — 16 being the DB member stride of
...
_message_definition message_vehicle_new_definition =
{
    _message_vehicle_new,                    /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_object_index_definition, 20, 20, 0 },             /* [ 5] */
            { &field_properties_object_index_definition, 24, 24, 0 },             /* [ 6] */
            { &field_properties_object_index_definition, 28, 28, 0 },             /* [ 7] */
            { &field_properties_object_index_definition, 32, 32, 0 },             /* [ 8] */
            { &field_properties_integer_small_definition, 96, 96, 0 },            /* [ 9] */
            { &field_properties_point3d_definition, 36, 36, 0 },                  /* [10] */
            { &field_properties_fixed_width_normal_8bit_definition, 48, 48, 0 },  /* [11] */
            { &field_properties_fixed_width_normal_8bit_definition, 60, 60, 0 },  /* [12] */
            { &field_properties_translational_velocity_definition, 72, 72, 0 },   /* [13] */
            { &field_properties_angular_velocity_definition, 84, 84, 0 },         /* [14] */
