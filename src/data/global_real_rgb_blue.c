/* global_real_rgb_blue @ 0x84176DB4 (.data, 4 bytes)  DB decl: const real_rgb_color *global_real_rgb_blue;
 * Image bytes (big-endian), reconstructed from the binary .data record:
 *   +0x0000 = 0x82113F5C -> &private_real_argb_colors[5].rgb   (private_real_argb_colors+0x054 = element 5 + 4)
 *
 * That sub-object decodes big-endian to 00000000 00000000 3F800000 = { red 0.0, green 0.0, blue 1.0 } = blue.
