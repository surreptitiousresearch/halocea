#include <stdint.h>
/* rasterizer_environment_specular_lightmap_draw 0x836A6260 (thunk) — tail-call thunk to the underscore rasterizer implementation. */
struct shader;
struct vertex_buffer;

extern void _rasterizer_environment_specular_lightmap_draw(const struct shader *shader, __int16 shader_permutation_index, int dynamic_triangle_buffer_index, int first_triangle_index, int triangle_count, const struct vertex_buffer *vertex_buffer);
