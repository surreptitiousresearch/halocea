/* build_game_variant_rally @0x8374FC58 — default "Rally" variant: solo race (engine 5) to 15 laps over a
 * rally (random-order) course (terminator.ignored = 2 in the race view), instant respawn. */
...
game_variant * build_game_variant_rally(game_variant *result)
{
