// FUNCTION_INDEX entry: ds_data::dsDATA_TYPE_IMPL<haloRAW_INPUT_X360_ENV>::Save @0x823BF380 (?Save@?$dsDATA_TYPE_IMPL@UhaloRAW_INPUT_X360_ENV@@@ds_data@@UBAHPBKPAVfioFILE@@@Z)
