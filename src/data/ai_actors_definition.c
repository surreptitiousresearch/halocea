/* ai_actors_definition @ 0x8211ADE8 — hs_function_table entry for the HaloScript "ai_actors" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0017 -> hs_type_object_list
 *   +0x04 name                   = 0x8211723C -> "ai_actors"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372B1B0 -> object_list_from_ai_reference_evaluate
...
extern void object_list_from_ai_reference_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_actors_definition =
{
    hs_type_object_list,         /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_actors",                 /* name */
    hs_macro_function_parse,     /* parse */
    object_list_from_ai_reference_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
