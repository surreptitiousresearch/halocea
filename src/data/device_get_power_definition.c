/* device_get_power_definition @ 0x8211A0E0 — hs_function_table entry for the HaloScript "device_get_power" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0006 -> hs_type_real
 *   +0x04 name                   = 0x82117A94 -> "device_get_power"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729288 -> device_get_power_evaluate
...
extern void device_get_power_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition device_get_power_definition =
{
    hs_type_real,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "device_get_power",          /* name */
    hs_macro_function_parse,     /* parse */
    device_get_power_evaluate,   /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
