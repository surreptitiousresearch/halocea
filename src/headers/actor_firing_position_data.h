...
{
    __int16          current_position_index;                       /* 0x00 (952) — claimed firing position,
                                                                      * -1/0xFFFF none (actor_change_firing_position.c) */
    unsigned __int8  current_position_found_outside_range;          /* 0x02 (954) */
    unsigned __int8  moved_away_from_firing_position;                /* 0x03 (955) */
    unsigned __int8  pursuit_fired_at_orphan;                        /* 0x04 */
    unsigned __int8  pursuit_communicated_lost_contact;              /* 0x05 */
    unsigned char    _pad06[2];                                       /* 0x06 */
    int              pursuit_prop_index;                              /* 0x08 */
    __int16          pursuit_positions_count;                          /* 0x0C */
    __int16          next_discarded_firing_positions_entry;            /* 0x0E */
    actor_discarded_firing_position discarded_firing_positions[4];      /* 0x10 */
    unsigned __int8  last_discarded_firing_position_valid;              /* 0x20 */
    unsigned __int8  last_discarded_firing_position_temporary;          /* 0x21 */
