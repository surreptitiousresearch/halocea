/* ui_widget_show_path_definition @ 0x8211C3F4 — hs_function_table entry for the HaloScript "ui_widget_show_path" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821161C8 -> "ui_widget_show_path"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DEA8 -> ui_widget_debug_show_path_evaluate
...
extern void ui_widget_debug_show_path_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ui_widget_show_path_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ui_widget_show_path",       /* name */
    hs_macro_function_parse,     /* parse */
    ui_widget_debug_show_path_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
