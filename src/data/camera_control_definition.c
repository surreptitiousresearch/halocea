/* camera_control_definition @ 0x8211AEA8 — hs_function_table entry for the HaloScript "camera_control" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821171C8 -> "camera_control"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372B3B0 -> director_script_camera_evaluate
...
extern void director_script_camera_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition camera_control_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "camera_control",            /* name */
    hs_macro_function_parse,     /* parse */
    director_script_camera_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
