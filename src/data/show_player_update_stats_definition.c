/* show_player_update_stats_definition @ 0x8211BDE4 — hs_function_table entry for the HaloScript "show_player_update_stats" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821166D4 -> "show_player_update_stats"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D208 -> player_update_history_show_statistics_from_console_evaluate
...
extern void player_update_history_show_statistics_from_console_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition show_player_update_stats_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "show_player_update_stats",  /* name */
    hs_macro_function_parse,     /* parse */
    player_update_history_show_statistics_from_console_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
