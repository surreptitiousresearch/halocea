/* structure_lens_flares_place_definition @ 0x8211BE5C — hs_function_table entry for the HaloScript "structure_lens_flares_place" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8211666C -> "structure_lens_flares_place"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D308 -> structure_lens_flares_place_evaluate
...
extern void structure_lens_flares_place_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition structure_lens_flares_place_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "structure_lens_flares_place", /* name */
    hs_macro_function_parse,     /* parse */
    structure_lens_flares_place_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
