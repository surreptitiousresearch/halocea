/* build_game_variant_team_race @0x8374FD30 — default "Team Race" variant: identical to Race but with
 * teams enabled. */
...
game_variant * build_game_variant_team_race(game_variant *result)
{
