...
/* shader_transparent_glass reflection type — the reflection.type tag field of a
 * shader_transparent_glass definition (read here as LOWORD(shader[3].base.radiosity.color.blue)).
