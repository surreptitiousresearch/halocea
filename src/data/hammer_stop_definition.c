/* hammer_stop_definition @ 0x8211BD34 — hs_function_table entry for the HaloScript "hammer_stop" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8211674C -> "hammer_stop"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D0A8 -> hammer_stop_evaluate
...
extern void hammer_stop_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition hammer_stop_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "hammer_stop",               /* name */
    hs_macro_function_parse,     /* parse */
    hammer_stop_evaluate,        /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
