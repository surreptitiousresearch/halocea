/* object_pvs_set_object_definition @ 0x821199F4 — hs_function_table entry for the HaloScript "object_pvs_set_object" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117F80 -> "object_pvs_set_object"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x837281B8 -> object_pvs_set_object_evaluate
 *   +0x10 documentation          = 0x8200155A
 *   +0x14 parameters             = 0x00000000 (NULL)
 *   +0x18 console_flags          = 0x00
 *   +0x1A formal_parameter_count = 1  (+0x1C formal_parameters = hs_type_object)
 */
...
extern void object_pvs_set_object_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition object_pvs_set_object_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "object_pvs_set_object",     /* name */
    hs_macro_function_parse,     /* parse */
    object_pvs_set_object_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
    1,                           /* formal_parameter_count */
    { hs_type_object },  /* formal_parameters */
};
