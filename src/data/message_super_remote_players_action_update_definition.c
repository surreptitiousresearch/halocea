/* message_super_remote_players_action_update_definition @ 0x8417E038 (.data, 168 bytes) — the message-delta message definition for
 * `_message_super_remote_players_action_update` (id 37): up to 32 remote players' control/action updates in one iterated message.
 * Per-message header set: message_header_remote_player_action_update_header_definition; 7 body fields.
 * Encoder call site cross-checked in headers/message_delta_message_ids.h: 0x83756ED0 passes id 37.
 *
 * Per-field provenance, decoded big-endian straight from the image bytes:
 *   +0x00 definition_type                    = 0x00000025 -> _message_super_remote_players_action_update
 ...
 *   +0x14 max_iterations                     = 0x00000020 -> 32
 ...
 * 0x8417E0E0, i.e. 168 bytes, and 0x28 + (7 + 1) * 16 == 168 — 16 being the DB member stride of
...
_message_definition message_super_remote_players_action_update_definition =
{
    _message_super_remote_players_action_update, /* definition_type */
