...
typedef struct object_type_definition
{
    ...
    __int16         game_datum_size;                        /* 0x08 */
    __int16         placement_tag_block_offset;             /* 0x0A */
    __int16         palette_tag_block_offset;               /* 0x0C */
    __int16         placement_tag_block_element_size;       /* 0x0E */
    ...
    unsigned __int8 (*datum_new)(int);                      /* 0x28 */
    void          (*datum_place)(int, void *);              /* 0x2C */
    void          (*datum_delete)(int);                     /* 0x30 */
    unsigned __int8 (*datum_update)(int);                   /* 0x34 */
    void          (*datum_export_function_values)(int);     /* 0x38 */
    void          (*handle_deleted_object)(int, int);       /* 0x3C */
    void          (*handle_region_destroyed)(int, __int16, unsigned int); /* 0x40 */
    unsigned __int8 (*handle_parent_destroyed)(int);        /* 0x44 */
    ...
    unsigned __int8 (*should_render_debug_object_network_visualization)(int); /* 0x60 */
    ...
    unsigned __int8 (*should_try_sending_incremental)(int); /* 0x74 */
    unsigned __int8 (*should_send_incremental_to_player)(int, int); /* 0x78 */
