/* unit_get_health_definition @ 0x82119F24 — hs_function_table entry for the HaloScript "unit_get_health" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0006 -> hs_type_real
 *   +0x04 name                   = 0x82117C0C -> "unit_get_health"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728E18 -> unit_scripting_get_health_evaluate
...
extern void unit_scripting_get_health_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition unit_get_health_definition =
{
    hs_type_real,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "unit_get_health",           /* name */
    hs_macro_function_parse,     /* parse */
    unit_scripting_get_health_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
