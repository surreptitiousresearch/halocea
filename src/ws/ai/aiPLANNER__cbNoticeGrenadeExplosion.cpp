...
// aiPLANNER::cbNoticeGrenadeExplosion @ 0x83254480
// ?cbNoticeGrenadeExplosion@aiPLANNER@@QAAXHPAVdsDATA@@AAV2@VsslOBJ_REF@@@Z
//
// SSL callback: resolve the object reference in argv[0] against the script system to an actor and
// forward it to implNoticeGrenadeExplosion. `caller` releases on return.
void aiPLANNER::cbNoticeGrenadeExplosion(int /*argc*/, dsDATA *argv, dsDATA & /*retVal*/,
                                         sslOBJ_REF /*caller*/)
{
    sslOBJ_REF ref;
    ...
    implNoticeGrenadeExplosion(actor);
