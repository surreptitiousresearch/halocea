/* _field_type_fixed_width_normal_vector_size_calculator @0x8379C610 — the fixed-width normal-vector field
...
int _field_type_fixed_width_normal_vector_size_calculator(_field_properties_definition *const field_properties_definition)
{
