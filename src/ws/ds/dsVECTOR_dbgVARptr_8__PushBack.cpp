...
class dbgVAR; // boundary — dbg engine registered debug variable (opaque; element is a pointer)

// dsVECTOR<dbgVAR *,8>::PushBack @ 0x8255FFC8
...
template<>
dbgVAR *&dsVECTOR<dbgVAR *, 8>::PushBack(dbgVAR *const &val)
{
