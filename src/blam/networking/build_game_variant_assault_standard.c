/* build_game_variant_assault_standard @0x8374A950 — "Assault" standard-lobby variant: ctf engine (1) in
 * assault mode, 5 captures to win, 5-minute vehicle respawn, team autobalance on, 300-tick friendly-fire
 * penalty, vehicle sets 0x09240000, standard flags mask (0xFFFFFE00 | 0x103). */
...
game_variant * build_game_variant_assault_standard(game_variant *result)
{
    ...
    result->game_engine_variant.ctf.single_flag_time = 3600;
