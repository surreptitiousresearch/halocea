/* vehicle_unload_definition @ 0x82119E48 — hs_function_table entry for the HaloScript "vehicle_unload" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0007 -> hs_type_short_integer
 *   +0x04 name                   = 0x82117C80 -> "vehicle_unload"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728C18 -> vehicle_scripting_unload_evaluate
...
extern void vehicle_scripting_unload_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition vehicle_unload_definition =
{
    hs_type_short_integer,       /* return_type */
    { 0, 0 },                    /* _pad02 */
    "vehicle_unload",            /* name */
    hs_macro_function_parse,     /* parse */
    vehicle_scripting_unload_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
