/* build_game_variant_endurance @0x8374EBF8 — default "Endurance" variant: Slayer (engine 2) with odd man
 * out, 5 lives, 10 kills to win, a 300-tick respawn growth, and no radar. */
...
game_variant * build_game_variant_endurance(game_variant *result)
{
    ...
    result->universal_variant.odd_man_out = 1;
