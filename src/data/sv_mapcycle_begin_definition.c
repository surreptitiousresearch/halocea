/* sv_mapcycle_begin_definition @ 0x8211C910 — hs_function_table entry for the HaloScript "sv_mapcycle_begin" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115B9C -> "sv_mapcycle_begin"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E938 -> sv_mapcycle_begin_evaluate
 *   +0x10 documentation          = 0x82115B60
...
extern void sv_mapcycle_begin_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_mapcycle_begin_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_mapcycle_begin",         /* name */
    hs_macro_function_parse,     /* parse */
    sv_mapcycle_begin_evaluate,  /* evaluate */
    "Restart or begin playing the currently loaded mapcycle file", /* documentation */
    0,                           /* parameters */
