/* global_vector_palette @ 0x841768F8 (.data, 1024 bytes)
 * DB applied_types: unsigned int global_vector_palette[256];
 ...
 *   +0x0098 = 0xFF8060FB
 *   +0x009C = 0xFF8160FB
 *   ... 864 further bytes elided; full hex in .sweep/data_image.tsv
 * .data data-init (unsigned int[256]).
 * ARGB lighting normal-palette lookup; 256 entries verified big-endian.
 */
unsigned int global_vector_palette[256] = {
