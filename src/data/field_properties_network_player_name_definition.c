/* field_properties_network_player_name_definition @ 0x84181798 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "network_player_name" network field type (_field_type_wide_string): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_network_player_name_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x00000006 -> _field_type_wide_string
 *   +0x04 name[75]      = "network_player_name" (56 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 *   +0x50 encode        = 0x8379AD10 -> default_wide_string_encoder
 *   +0x54 decode        = 0x8379ADC0 -> default_wide_string_decoder
 *   +0x58 parameters    = 0x84181790 -> &field_properties_network_player_name_parameters
...
extern _field_type_wide_string_parameters field_properties_network_player_name_parameters; /* 0x84181790 */

_field_properties_definition field_properties_network_player_name_definition =
{
    _field_type_wide_string,                      /* type */
    "network_player_name",                        /* name[75] */
    { 0 },                                        /* _pad4F */
    default_wide_string_encoder,                  /* encode */
    default_wide_string_decoder,                  /* decode */
    &field_properties_network_player_name_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
