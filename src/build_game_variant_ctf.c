/* build_game_variant_ctf @0x8374F800 — default "Capture the Flag" variant: ctf engine (1), teams, goal
 * radar, 3 captures to win, 300-tick respawn, weapon set 11, vehicle sets 0x28000000, all ctf-specific
 * options off. */
...
game_variant * build_game_variant_ctf(game_variant *result)
{
