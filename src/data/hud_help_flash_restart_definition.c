/* hud_help_flash_restart_definition @ 0x8211BBE0 — hs_function_table entry for the HaloScript "hud_help_flash_restart" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116858 -> "hud_help_flash_restart"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372CDB0 -> scripted_hud_restart_flashing_evaluate
...
extern void scripted_hud_restart_flashing_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition hud_help_flash_restart_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "hud_help_flash_restart",    /* name */
    hs_macro_function_parse,     /* parse */
    scripted_hud_restart_flashing_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
