/* display_scenario_help_definition @ 0x8211C414 — hs_function_table entry for the HaloScript "display_scenario_help" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821161B0 -> "display_scenario_help"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DEF0 -> display_scenario_help_evaluate
...
extern void display_scenario_help_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition display_scenario_help_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "display_scenario_help",     /* name */
    hs_macro_function_parse,     /* parse */
    display_scenario_help_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
