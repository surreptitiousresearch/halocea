 ...
 * consume r3 and 6 narrow it with `extsh` first — decisively, hs_scenario_merge @0x8372EB20 does
 ...
 * consumes r3 does it with `clrlwi rX, r3, 24` — hs_scenario_postprocess @0x8372FF30,
 * leaf_map_initialize_from_bsp @0x8381C380 et al. — a zero-extend of the low byte, the Blam bool. */
 ...
 * (hs_scenario_merge @0x8372EB20, hs_compile_finish @0x8377A018/@0x8377A1FC, …) — the identical
