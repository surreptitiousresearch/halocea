/* field_properties_fixed_width_normal_8bit_definition @ 0x841836E0 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "fixed_width_normal_8bit" network field type (_field_type_fixed_width_normal_vector): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_fixed_width_normal_8bit_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x00000015 -> _field_type_fixed_width_normal_vector
 *   +0x04 name[75]      = "fixed_width_normal_8bit" (52 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 ...
 *   +0x58 parameters    = 0x841836D0 -> &field_properties_fixed_width_normal_8bit_parameters
...
extern _field_type_fixed_width_normal_vector_parameters field_properties_fixed_width_normal_8bit_parameters; /* 0x841836D0 */

_field_properties_definition field_properties_fixed_width_normal_8bit_definition =
{
    _field_type_fixed_width_normal_vector,        /* type */
    "fixed_width_normal_8bit",                    /* name[75] */
    { 0 },                                        /* _pad4F */
    default_fixed_width_normal_vector_encoder,    /* encode */
    default_fixed_width_normal_vector_decoder,    /* decode */
    &field_properties_fixed_width_normal_8bit_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
