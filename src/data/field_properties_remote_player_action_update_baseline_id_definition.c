/* field_properties_remote_player_action_update_baseline_id_definition @ 0x84183190 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "remote_player_action_update_baseline_id" network field type (_field_type_integer): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_remote_player_action_update_baseline_id_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x00000000 -> _field_type_integer
 *   +0x04 name[75]      = "remote_player_action_update_baseline_id" (36 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 *   +0x50 encode        = 0x8379A798 -> default_integer_encoder
 *   +0x54 decode        = 0x8379A8D8 -> default_integer_decoder
 *   +0x58 parameters    = 0x84183188 -> &field_properties_remote_player_action_update_baseline_id_parameters
...
extern _field_type_integer_parameters field_properties_remote_player_action_update_baseline_id_parameters; /* 0x84183188 */

_field_properties_definition field_properties_remote_player_action_update_baseline_id_definition =
{
    _field_type_integer,                          /* type */
    "remote_player_action_update_baseline_id",    /* name[75] */
    { 0 },                                        /* _pad4F */
    default_integer_encoder,                      /* encode */
    default_integer_decoder,                      /* decode */
    &field_properties_remote_player_action_update_baseline_id_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
