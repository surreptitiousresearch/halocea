/* garbage_collect_now_definition @ 0x82119938 — hs_function_table entry for the HaloScript "garbage_collect_now" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82118000 -> "garbage_collect_now"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728010 -> garbage_collect_now_evaluate
...
extern void garbage_collect_now_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition garbage_collect_now_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "garbage_collect_now",       /* name */
    hs_macro_function_parse,     /* parse */
    garbage_collect_now_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
