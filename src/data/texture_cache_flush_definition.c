/* texture_cache_flush_definition @ 0x8211B364 — hs_function_table entry for the HaloScript "texture_cache_flush" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116DF4 -> "texture_cache_flush"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BE78 -> texture_cache_flush_evaluate
...
extern void texture_cache_flush_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition texture_cache_flush_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "texture_cache_flush",       /* name */
    hs_macro_function_parse,     /* parse */
    texture_cache_flush_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
