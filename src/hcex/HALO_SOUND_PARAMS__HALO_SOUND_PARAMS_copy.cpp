...
// 0x836BFBC0 — HALO_SOUND_PARAMS copy constructor. Copies every scalar/dsSTRID/dsFLAGS field,
// then deep-copies the `replace` vector: the new vector starts empty (adopting only the source's
// allocation call-site cookie) and Inserts the full source range at index 0.
