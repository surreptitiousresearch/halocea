/* eye_distance_to_fog_plane @ 0x8446C430 - data-bss zero-fill; DB applied-type `float eye_distance_to_fog_plane;`. DB type is 4 bytes; ledger size 8 is the next-symbol gap heuristic (overcount) - DB authoritative.
