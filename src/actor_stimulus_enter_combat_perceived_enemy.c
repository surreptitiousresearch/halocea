/* actor_stimulus_enter_combat_perceived_enemy @0x837D4258 — stimulus that pushes an actor into combat
...
void actor_stimulus_enter_combat_perceived_enemy(uint16_t actor_index, uint16_t prop_index)
{
