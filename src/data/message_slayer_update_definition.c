/* message_slayer_update_definition @ 0x841858D8 (.data, 88 bytes) — the message-delta message definition for
 * `_message_slayer_update` (id 16): the slayer game engine's score arrays.
 ...
 *   +0x00 definition_type                    = 0x00000010 -> _message_slayer_update
 ...
 *   +0x28   field_references[ 0]             = { 0x84185870 -> &field_properties_slayer_score_array_definition, offset 64, baseline_offset 64, initialized 0 }
 *   +0x38   field_references[ 1]             = { 0x84185870 -> &field_properties_slayer_score_array_definition, offset 0, baseline_offset 0, initialized 0 }
 ...
 * 0x84185930, i.e. 88 bytes, and 0x28 + (2 + 1) * 16 == 88 — 16 being the DB member stride of
...
extern _field_properties_definition field_properties_slayer_score_array_definition;                                /* 0x84185870 */

_message_definition message_slayer_update_definition =
{
    _message_slayer_update,                  /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            { &field_properties_slayer_score_array_definition, 64, 64, 0 },  /* [ 0] */
            { &field_properties_slayer_score_array_definition, 0, 0, 0 },    /* [ 1] */
