/* build_game_variant_juggernaut_standard @0x8374ABF8 — "Juggernaut" standard-lobby variant: oddball engine
 * (3) with ball type "terminator" and extra-damage trait while carrying it, no teams, 150-tick instant
 * respawn, 15 points to win, vehicle sets 0x09240000, standard flags mask (0xFFFFFE00 | 0x103). */
...
game_variant * build_game_variant_juggernaut_standard(game_variant *result)
{
