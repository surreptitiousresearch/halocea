/* D3DDevice_SetStreamSource_Inline_1 @0x82697C08 */
...
void D3DDevice_SetStreamSource_Inline_1(D3DDevice *pDevice, unsigned int StreamNumber, D3DVertexBuffer *pStreamData, unsigned int OffsetInBytes, unsigned int Stride)
{
