/* message_header_biped_update_header_definition @ 0x84184878 (.data, 104 bytes) — the shared per-message HEADER
 * field-reference set "biped_update_header": the fields every message carrying this header serializes ahead
 ...
 * DB applied_types: _message_definition_field_reference_set message_header_biped_update_header_definition;
 ...
 *   +0x048   [ 4] = { 0x84183960 -> &field_properties_boolean_definition, offset 7, baseline_offset 7, initialized 0 }
...
_message_definition_field_reference_set message_header_biped_update_header_definition =
{
    5,                                       /* count */
    -1,                                      /* maximum_data_size */
