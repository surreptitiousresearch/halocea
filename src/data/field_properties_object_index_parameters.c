/* field_properties_object_index_parameters @ 0x841833A4 (.data, 44 bytes)
 * DB applied_types: _field_type_translated_index_parameters field_properties_object_index_parameters;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 maximum_active_at_once     = 0x000001FF
 *   +0x04 initial_translation_table_size = 0x00000080
...
_field_type_translated_index_parameters field_properties_object_index_parameters = {
    .maximum_active_at_once         = 511, /* 0x000001FF */
    .initial_translation_table_size = 128, /* 0x00000080 */
