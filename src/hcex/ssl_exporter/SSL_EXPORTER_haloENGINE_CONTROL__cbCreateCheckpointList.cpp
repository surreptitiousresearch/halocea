/* ?cbCreateCheckpointList@SSL_EXPORTER_haloENGINE_CONTROL@@SAXVsslOBJ_REF@@HPAVdsDATA@@AAV3@0@Z @0x823CB128 */
...
void SSL_EXPORTER_haloENGINE_CONTROL::cbCreateCheckpointList(sslOBJ_REF self, int argc, dsDATA *argv, dsDATA *retVal, sslOBJ_REF caller)
{
    static ds_data_call::HandlerBase_haloENGINE_CONTROL *method =
        ds_data_call::CreateHandler<haloENGINE_CONTROL, haloENGINE_CONTROL, ds_data::REF_TYPE<dsREF_VECTOR>, const dsTSTRING<char> &>(&haloENGINE_CONTROL::CreateCheckpointList);
