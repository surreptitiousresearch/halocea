/* profile_unlock_solo_levels_definition @ 0x8211C380 — hs_function_table entry for the HaloScript "profile_unlock_solo_levels" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116238 -> "profile_unlock_solo_levels"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DD98 -> player_ui_activate_all_solo_levels_evaluate
...
extern void player_ui_activate_all_solo_levels_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition profile_unlock_solo_levels_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "profile_unlock_solo_levels", /* name */
    hs_macro_function_parse,     /* parse */
    player_ui_activate_all_solo_levels_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
