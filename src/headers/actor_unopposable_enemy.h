...
{
    int16_t     unopposable_type;       /* 0x00 — 0 (init); threat tier 0..9 raised through the pass */
    char        _pad02[2];              /* 0x02 */
    ...
    int16_t     friends_retreating;     /* 0x10 — 0 (init); count of nearby allies already retreating */
    char        _pad12[2];              /* 0x12 */
