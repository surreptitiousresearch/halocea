...
extern void hcex_tex_2d_copytohw(void *tex, void *tex_data, int width, int height, int mipmaps, _D3DFORMAT fmt, int tex_size);

void rasterizer_bitmap_2d_changed(bitmap_data *bitmap)
{
    ...
    hcex_tex_2d_copytohw(hardware_format, base_address, bitmap->width, bitmap->height,
