// sslSOURCE::~sslSOURCE @0x82A36FE8 (body inlined into the scalar-deleting-dtor entry point; no
...
// sslSOURCE::`scalar deleting destructor' @0x82A36FE8 — runs ~sslSOURCE(), then conditionally
