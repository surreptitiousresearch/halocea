/* switch_bsp_definition @ 0x8211B2F0 — hs_function_table entry for the HaloScript "switch_bsp" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116E28 -> "switch_bsp"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BD78 -> scenario_switch_structure_bsp_evaluate
...
extern void scenario_switch_structure_bsp_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition switch_bsp_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "switch_bsp",                /* name */
    hs_macro_function_parse,     /* parse */
    scenario_switch_structure_bsp_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
