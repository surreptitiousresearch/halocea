...
template<>
void dsVECTOR<objOBJ *, 8>::Insert(int pos, objOBJ *const *begin, int count)
{
    ...
    memmove(&this->pData[pos + count], &this->pData[pos], sizeof(objOBJ *) * (this->nElem - pos));
