/* build_game_variant_elimination @0x8374EA48 — default "Elimination" variant: Slayer (engine 2) with a
 * single life, 25 kills to win, instant respawn and no radar. */
...
game_variant * build_game_variant_elimination(game_variant *result)
{
