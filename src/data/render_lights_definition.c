/* render_lights_definition @ 0x82119A70 — hs_function_table entry for the HaloScript "render_lights" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82117F30 -> "render_lights"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x837282C8 -> lights_enable_evaluate
...
extern void lights_enable_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition render_lights_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "render_lights",             /* name */
    hs_macro_function_parse,     /* parse */
    lights_enable_evaluate,      /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
