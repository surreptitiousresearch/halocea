/* build_game_variant_crazy_king @0x8374F658 — populate `result` with the default "Crazy King" variant:
 * identical to build_game_variant_king except respawn time is 0 and the hill moves
 * (ctf.assault = 1 in the king view of the engine union). */
...
game_variant * build_game_variant_crazy_king(game_variant *result)
{
