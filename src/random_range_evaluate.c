...
{
    /* DEVIATION: `stw r11, 0x50(r1)` @0x83727A34 zeroes the WHOLE word — the halfword */
    ...
    if ( arguments )
    {
        ...
        int result = (int)((uint16_t)(seed_random_range(get_global_random_seed_address(), lower, upper))) << 16;
