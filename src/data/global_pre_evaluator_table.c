/* global_pre_evaluator_table @ 0x821285F8 (.rdata, 56 bytes)
 * DB applied_types: const pre_evaluator_table_entry global_pre_evaluator_table[7];
 * Image bytes (big-endian), decoded from the binary .rdata record:
 *   [ 0] +0x00 evaluation_mode_mask       = 0xFFFF
 *        +0x04 evaluation_function        = 0x837EFE90 -> pre_evaluator_global
 *   [ 1] +0x00 evaluation_mode_mask       = 0x0009
 *        +0x04 evaluation_function        = 0x837EEA50 -> pre_evaluator_attack
 *   [ 2] +0x00 evaluation_mode_mask       = 0x004D
 *        +0x04 evaluation_function        = 0x837EED08 -> pre_evaluator_combatmove
 *   [ 3] +0x00 evaluation_mode_mask       = 0x0010
 *        +0x04 evaluation_function        = 0x837EE9A8 -> pre_evaluator_guard
 *   [ 4] +0x00 evaluation_mode_mask       = 0x0002
 *        +0x04 evaluation_function        = 0x837EE7A8 -> pre_evaluator_panic
 *   [ 5] +0x00 evaluation_mode_mask       = 0x0020
 *        +0x04 evaluation_function        = 0x837EE650 -> pre_evaluator_pursuit
 *   [ 6] +0x00 evaluation_mode_mask       = 0x0000
 *        +0x04 evaluation_function        = 0x00000000
 * .rdata, 56 bytes = 7 x pre_evaluator_table_entry
...
/* Field order per row (pre_evaluator_table_entry, DB-verified layout):
