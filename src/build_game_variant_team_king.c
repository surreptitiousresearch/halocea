/* build_game_variant_team_king @0x8374F728 — default "Team King" variant: King of the Hill (engine 4)
 * with teams on, a 300-tick respawn — and, unlike solo King, a MOVING hill (ctf.assault = 1 in the king
 * view of the engine union). */
...
game_variant * build_game_variant_team_king(game_variant *result)
{
