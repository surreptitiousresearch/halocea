...
typedef struct lens_flare_definition
{
    ...
    __int16           occlusion_offset_direction;     /* 0x14 */
    unsigned __int16  occlusion_pad;                  /* 0x16 */
    float             near_fade_distance;             /* 0x18 */
    float             far_fade_distance;              /* 0x1C */
    tag_reference     primary_map;                    /* 0x20 */
    unsigned __int16  flags;                          /* 0x30 */
    unsigned __int16  pad;                            /* 0x32 */
    int               unused1[19];                    /* 0x34 */
    __int16           corona_rotation_function;       /* 0x80 */
    unsigned __int16  corona_rotation_pad;             /* 0x82 */
