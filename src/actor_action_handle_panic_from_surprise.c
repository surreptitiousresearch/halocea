/* actor_action_handle_panic_from_surprise @0x837F1D10 — transitions into panic when a pending "surprised"
...
uint8_t actor_action_handle_panic_from_surprise(int actor_index)
{
