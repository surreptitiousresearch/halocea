...
typedef struct pre_evaluator_table_entry
{
    ...
    void (__fastcall *evaluation_function)(int actor_index, firing_position_evaluation_context *context, int16_t firing_position_count, firing_position *firing_positions); /* 0x4 */
