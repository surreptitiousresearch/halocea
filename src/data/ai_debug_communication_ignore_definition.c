/* ai_debug_communication_ignore_definition @ 0x821192C4 — hs_function_table entry for the HaloScript "ai_debug_communication_ignore" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821184E8 -> "ai_debug_communication_ignore"
 *   +0x08 parse                  = 0x83779B70 -> hs_parse_debug_string
 *   +0x0C evaluate               = 0x83690590 -> hs_evaluate_debug_string
 *   +0x10 documentation          = 0x82118488
...
const hs_function_definition ai_debug_communication_ignore_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_debug_communication_ignore", /* name */
    hs_parse_debug_string,       /* parse */
    hs_evaluate_debug_string,    /* evaluate */
    "ignores (or stops ignoring) a set of AI communication types when printing out communications.", /* documentation */
    "<string(s)>",               /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
