...
{
    unsigned __int8 ai_active;                      /* 0x00 */
    unsigned __int8 ai_initialized_for_map;         /* 0x01 */
    unsigned __int8 ai_has_control_data;            /* 0x02 */
    unsigned __int8 time_given_this_frame;          /* 0x03 */
    __int16         last_highest_service_timer;     /* 0x04 */
    __int16         current_highest_service_timer;  /* 0x06 */
    int             first_encounterless_actor_index;/* 0x08 */
    float           major_upgrade_error;            /* 0x0C */
    unsigned __int8 dialogue_triggers_enabled;      /* 0x10 */
    unsigned char   _pad11[3];                      /* 0x11 */
    int             last_chatter_time[2];           /* 0x14 */
    int             last_talk_time[2];              /* 0x1C */
    int             last_shout_time[2];             /* 0x24 */
    __int16         recent_conversation_count;      /* 0x2C */
    __int16         recent_conversation_next_index; /* 0x2E */
    recent_conversation recent_conversations[16];   /* 0x30 */
    __int16         spatial_effects_first_index;    /* 0x130 */
    __int16         spatial_effects_last_index;     /* 0x132 */
    ai_spatial_effect spatial_effects[32];           /* 0x134 — AI noise/stimulus ring buffer */
    unsigned __int8 grenades_enabled;               /* 0x3B4 */
    unsigned char   _pad3B5;                         /* 0x3B5 */
    __int16         enterable_vehicle_count;        /* 0x3B6 */
    ai_vehicle_enterable enterable_vehicles[32];     /* 0x3B8 — script-registered AI-enterable vehicles */
    __int16         mounted_weapon_unit_count;      /* 0x8B8 */
    __int16         _pad8BA;                         /* 0x8BA */
