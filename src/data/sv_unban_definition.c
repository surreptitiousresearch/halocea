/* sv_unban_definition @ 0x8211C7E8 — hs_function_table entry for the HaloScript "sv_unban" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115ED4 -> "sv_unban"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E6C0 -> sv_unban_evaluate
 *   +0x10 documentation          = 0x82115E60
...
extern void sv_unban_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_unban_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_unban",                  /* name */
    hs_macro_function_parse,     /* parse */
    sv_unban_evaluate,           /* evaluate */
    "<Server Only> Usage: sv_unban <index> \nRemoves player at index in the banlist.  Use sv_banlist to find the index", /* documentation */
    0,                           /* parameters */
