/* field_type_enumeration_size_calculator @0x8379B798 — the enumeration field type's maximum_size_calculator
...
int field_type_enumeration_size_calculator(_field_properties_definition *const field_properties_definition)
{
