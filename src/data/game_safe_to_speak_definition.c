/* game_safe_to_speak_definition @ 0x8211B744 — hs_function_table entry for the HaloScript "game_safe_to_speak" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82116B6C -> "game_safe_to_speak"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C388 -> game_safe_to_speak_evaluate
...
extern void game_safe_to_speak_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition game_safe_to_speak_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "game_safe_to_speak",        /* name */
    hs_macro_function_parse,     /* parse */
    game_safe_to_speak_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
