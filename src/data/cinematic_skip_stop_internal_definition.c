/* cinematic_skip_stop_internal_definition @ 0x8211B61C — hs_function_table entry for the HaloScript "cinematic_skip_stop_internal" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116C38 -> "cinematic_skip_stop_internal"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C118 -> cinematic_skip_stop_evaluate
...
extern void cinematic_skip_stop_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition cinematic_skip_stop_internal_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "cinematic_skip_stop_internal", /* name */
    hs_macro_function_parse,     /* parse */
    cinematic_skip_stop_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
