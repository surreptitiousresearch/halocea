...
extern void encounter_modify_pursuit_desires(int encounter_index, int16_t squad_index, uint8_t *pursue_tenacious, int16_t *group_pursuit_restriction, uint8_t *group_pursuit_controller, int16_t *desired_target_search, int16_t *desired_pursuit, int16_t *desired_pursuit_search);
...
extern uint8_t action_uncover_setup_pursuit(int actor_index, int16_t firing_position_index, uncover_state_data *state_data);
extern uint8_t action_search_setup_target(int actor_index, uint8_t must_charge, search_state_data *state_data);
extern uint8_t action_search_setup_pursuit(int actor_index, int16_t firing_position_index, uint8_t tenacious, search_state_data *state_data);
extern int action_search_setup_undirected(int actor_index, uint8_t tenacious, search_state_data *state_data);
extern uint8_t action_wait_setup(int actor_index, uint8_t actively_searching, wait_state_data *state_data);
