/* build_game_variant_team_slayer_standard @0x8374B320 — "Team Slayer" standard-lobby variant: slayer
 * engine (2), teams, 50 kills to win, 10-minute time limit, team autobalance on, 300-tick friendly-fire
 * penalty, vehicle sets 0x09240000, standard flags mask (0xFFFFFE00 | 0x143). */
...
game_variant * build_game_variant_team_slayer_standard(game_variant *result)
{
