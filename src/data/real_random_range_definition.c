/* real_random_range_definition @ 0x821196FC — hs_function_table entry for the HaloScript "real_random_range" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0006 -> hs_type_real
 *   +0x04 name                   = 0x821181B8 -> "real_random_range"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83727A78 -> real_random_range_evaluate
...
extern void real_random_range_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition real_random_range_definition =
{
    hs_type_real,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "real_random_range",         /* name */
    hs_macro_function_parse,     /* parse */
    real_random_range_evaluate,  /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
