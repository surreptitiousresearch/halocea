 ...
 * a new object. 136 bytes; layout from the database. effect_generate_part also reuses this stack buffer as
 * scratch for damage_data and sound_location, hence the type-punned writes there. */
...
typedef struct object_placement_data
{
    ...
    __int16         owner_team_index;                /* 0x14 */
    __int16         variant_number;                  /* 0x16 */
