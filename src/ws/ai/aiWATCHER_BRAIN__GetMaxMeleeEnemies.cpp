...
// aiWATCHER_BRAIN::GetMaxMeleeEnemies @ 0x831702B0
// ?GetMaxMeleeEnemies@aiWATCHER_BRAIN@@UBAHXZ
...
int aiWATCHER_BRAIN::GetMaxMeleeEnemies() const
{
    ...
    return *reinterpret_cast<const int *>(desc + aiUNITDESC_off_maxMeleeEnemies);
}
