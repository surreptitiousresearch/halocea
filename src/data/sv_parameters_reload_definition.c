/* sv_parameters_reload_definition @ 0x8211C594 — hs_function_table entry for the HaloScript "sv_parameters_reload" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821160F0 -> "sv_parameters_reload"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E278 -> sv_parameters_reload_evaluate
...
extern void sv_parameters_reload_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_parameters_reload_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_parameters_reload",      /* name */
    hs_macro_function_parse,     /* parse */
    sv_parameters_reload_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
