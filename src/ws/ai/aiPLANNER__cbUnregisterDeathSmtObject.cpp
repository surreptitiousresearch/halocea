...
// aiPLANNER::cbUnregisterDeathSmtObject @ 0x832549F0
// ?cbUnregisterDeathSmtObject@aiPLANNER@@QAAXHPAVdsDATA@@AAV2@VsslOBJ_REF@@@Z
//
// SSL callback: resolve the object reference in argv[0] against the script system to an actor and
// forward it to implUnregisterDeathSmtObject. `caller` releases on return.
void aiPLANNER::cbUnregisterDeathSmtObject(int /*argc*/, dsDATA *argv, dsDATA & /*retVal*/,
                                           sslOBJ_REF /*caller*/)
{
    sslOBJ_REF ref;
    ...
    implUnregisterDeathSmtObject(actor);
