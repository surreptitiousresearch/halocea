/* game_all_quiet_definition @ 0x8211B728 — hs_function_table entry for the HaloScript "game_all_quiet" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82116B80 -> "game_all_quiet"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C340 -> game_all_quiet_evaluate
...
extern void game_all_quiet_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition game_all_quiet_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "game_all_quiet",            /* name */
    hs_macro_function_parse,     /* parse */
    game_all_quiet_evaluate,     /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
