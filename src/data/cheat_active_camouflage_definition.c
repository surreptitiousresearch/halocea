/* cheat_active_camouflage_definition @ 0x8211A290 — hs_function_table entry for the HaloScript "cheat_active_camouflage" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8211792C -> "cheat_active_camouflage"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729698 -> cheat_active_camouflage_evaluate
...
extern void cheat_active_camouflage_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition cheat_active_camouflage_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "cheat_active_camouflage",   /* name */
    hs_macro_function_parse,     /* parse */
    cheat_active_camouflage_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
