/* object_destroy_definition @ 0x821193F8 — hs_function_table entry for the HaloScript "object_destroy" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82118398 -> "object_destroy"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x837273B0 -> hs_object_destroy_evaluate
...
extern void hs_object_destroy_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition object_destroy_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "object_destroy",            /* name */
    hs_macro_function_parse,     /* parse */
    hs_object_destroy_evaluate,  /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
