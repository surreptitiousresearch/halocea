/* unit_has_weapon_definition @ 0x82119F84 — hs_function_table entry for the HaloScript "unit_has_weapon" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82117BCC -> "unit_has_weapon"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728F10 -> unit_scripting_has_weapon_evaluate
...
extern void unit_scripting_has_weapon_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition unit_has_weapon_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "unit_has_weapon",           /* name */
    hs_macro_function_parse,     /* parse */
    unit_scripting_has_weapon_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
