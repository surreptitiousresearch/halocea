/* ai_debug_teleport_to_definition @ 0x8211B504 — hs_function_table entry for the HaloScript "ai_debug_teleport_to" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116CE0 -> "ai_debug_teleport_to"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BF58 -> ai_debug_teleport_to_evaluate
...
extern void ai_debug_teleport_to_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_debug_teleport_to_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_debug_teleport_to",      /* name */
    hs_macro_function_parse,     /* parse */
    ai_debug_teleport_to_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
