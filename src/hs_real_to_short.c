 ...
 * CAVEAT: as-shipped — sth @0x8368D5F4 writes only the MSWord, lwz @0x8368D5F8 returns the whole
 * word; the low halfword is bytes 2-3 of the stfd'd fctiwz high word @0x8368D5EC (not defined by
 * the C-visible computation). */
