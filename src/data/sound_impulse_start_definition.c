/* sound_impulse_start_definition @ 0x8211B8FC — hs_function_table entry for the HaloScript "sound_impulse_start" function.
 * Initializer reconstructed from the binary .rdata record (36 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116A4C -> "sound_impulse_start"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C768 -> scripted_sound_new_evaluate
 *   +0x10 documentation          = 0x8200155A
 *   +0x14 parameters             = 0x00000000 (NULL)
 *   +0x18 console_flags          = 0x00
 *   +0x1A formal_parameter_count = 3  (+0x1C formal_parameters = hs_type_sound, hs_type_object, hs_type_real)
 */
...
extern void scripted_sound_new_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sound_impulse_start_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sound_impulse_start",       /* name */
    hs_macro_function_parse,     /* parse */
    scripted_sound_new_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
    3,                           /* formal_parameter_count */
    { hs_type_sound, hs_type_object, hs_type_real },  /* formal_parameters */
};
