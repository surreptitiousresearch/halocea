/* numeric_countdown_timer_restart_definition @ 0x82119778 — hs_function_table entry for the HaloScript "numeric_countdown_timer_restart" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82118140 -> "numeric_countdown_timer_restart"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83727BC8 -> numeric_countdown_timer_restart_evaluate
...
extern void numeric_countdown_timer_restart_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition numeric_countdown_timer_restart_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "numeric_countdown_timer_restart", /* name */
    hs_macro_function_parse,     /* parse */
    numeric_countdown_timer_restart_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
