/* checkpoint_save_definition @ 0x8211C60C — hs_function_table entry for the HaloScript "checkpoint_save" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116094 -> "checkpoint_save"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E378 -> game_state_save_last_checkpoint_evaluate
...
extern void game_state_save_last_checkpoint_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition checkpoint_save_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "checkpoint_save",           /* name */
    hs_macro_function_parse,     /* parse */
    game_state_save_last_checkpoint_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
