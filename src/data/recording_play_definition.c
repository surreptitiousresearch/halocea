/* recording_play_definition @ 0x821197B4 — hs_function_table entry for the HaloScript "recording_play" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82118114 -> "recording_play"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83727C48 -> recorded_animation_play_evaluate
...
extern void recorded_animation_play_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition recording_play_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "recording_play",            /* name */
    hs_macro_function_parse,     /* parse */
    recorded_animation_play_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
