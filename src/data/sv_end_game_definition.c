/* sv_end_game_definition @ 0x8211C860 — hs_function_table entry for the HaloScript "sv_end_game" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115D40 -> "sv_end_game"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E7C8 -> sv_end_game_evaluate
 *   +0x10 documentation          = 0x82115D28
...
extern void sv_end_game_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_end_game_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_end_game",               /* name */
    hs_macro_function_parse,     /* parse */
    sv_end_game_evaluate,        /* evaluate */
    "End the current game.",     /* documentation */
    0,                           /* parameters */
