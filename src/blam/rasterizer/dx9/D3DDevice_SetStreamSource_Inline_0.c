/* D3DDevice_SetStreamSource_Inline_0 @0x82693B40 */
...
void D3DDevice_SetStreamSource_Inline_0(D3DDevice *pDevice, unsigned int StreamNumber, D3DVertexBuffer *pStreamData, unsigned int OffsetInBytes, unsigned int Stride)
{
