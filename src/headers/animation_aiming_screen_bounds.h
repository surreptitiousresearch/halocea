...
typedef struct animation_aiming_screen_bounds
{
    ...
    __int16 negative_yaw_frame_count;     /* 0x08 */
    __int16 positive_yaw_frame_count;     /* 0x0A */
    float   negative_pitch_delta;         /* 0x0C */
    float   positive_pitch_delta;         /* 0x10 */
    __int16 negative_pitch_frame_count;   /* 0x14 */
    __int16 positive_pitch_frame_count;   /* 0x16 */
