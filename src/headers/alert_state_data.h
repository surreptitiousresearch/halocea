...
{
    __int16          move_position_order;         /* 0x00 */
    __int16          wait_ticks;                  /* 0x02 */
    unsigned __int8  move_position_increasing;     /* 0x04 */
    unsigned char _pad0[1]; /* db-verified padding */
    /* padding byte */                             /* 0x05 */
    __int16          target_move_position_index;   /* 0x06 */
    __int16          pending_move_position_index;  /* 0x08 */
    unsigned __int8  must_play_animation;          /* 0x0A */
