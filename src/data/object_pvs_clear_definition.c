/* object_pvs_clear_definition @ 0x82119A34 — hs_function_table entry for the HaloScript "object_pvs_clear" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117F54 -> "object_pvs_clear"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728248 -> object_pvs_clear_evaluate
...
extern void object_pvs_clear_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition object_pvs_clear_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "object_pvs_clear",          /* name */
    hs_macro_function_parse,     /* parse */
    object_pvs_clear_evaluate,   /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
