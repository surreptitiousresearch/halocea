/* player_control_action_test_zoom_evaluate @0x8372B928 — HaloScript builtin wrapper (no arguments); packs a boolean result. */

#include <stdint.h>

extern void hs_return(int thread_index, int value);
extern uint8_t player_control_action_test_zoom(void);
...
void player_control_action_test_zoom_evaluate(int16_t function_index, int thread_index, uint8_t initialize)
{
    ...
    int result = (int)((uint8_t)player_control_action_test_zoom()) << 24;
