...
typedef struct scenario_netgame_equipment
{
    ...
    __int16       game_type[4];                /* 0x04 — game-type filter (see match_game_type) */
    __int16       team_index;                  /* 0x0C */
    __int16       spawn_time;                  /* 0x0E — respawn period in seconds; 0 = use collection default */
