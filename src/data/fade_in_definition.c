/* fade_in_definition @ 0x8211B564 — hs_function_table entry for the HaloScript "fade_in" function.
 * Initializer reconstructed from the binary .rdata record (36 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116CB4 -> "fade_in"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BF88 -> player_effect_screen_fade_in_evaluate
...
extern void player_effect_screen_fade_in_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition fade_in_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "fade_in",                   /* name */
    hs_macro_function_parse,     /* parse */
    player_effect_screen_fade_in_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
