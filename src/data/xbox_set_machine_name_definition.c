/* xbox_set_machine_name_definition @ 0x8211C434 — hs_function_table entry for the HaloScript "xbox_set_machine_name" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116198 -> "xbox_set_machine_name"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DF38 -> xbox_set_machine_name_evaluate
...
extern void xbox_set_machine_name_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition xbox_set_machine_name_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "xbox_set_machine_name",     /* name */
    hs_macro_function_parse,     /* parse */
    xbox_set_machine_name_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
