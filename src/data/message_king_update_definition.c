/* message_king_update_definition @ 0x84186C00 (.data, 88 bytes) — the message-delta message definition for
 * `_message_king_update` (id 19): the king-of-the-hill game engine's score array and hill state.
 ...
 *   +0x00 definition_type                    = 0x00000013 -> _message_king_update
 ...
 *   +0x28   field_references[ 0]             = { 0x84186B98 -> &field_properties_king_score_array_definition, offset 0, baseline_offset 0, initialized 0 }
 *   +0x38   field_references[ 1]             = { 0x841833D0 -> &field_properties_integer_large_definition, offset 420, baseline_offset 420, initialized 0 }
 ...
 * 0x84186C58, i.e. 88 bytes, and 0x28 + (2 + 1) * 16 == 88 — 16 being the DB member stride of
...
extern _field_properties_definition field_properties_king_score_array_definition;                                  /* 0x84186B98 */
extern _field_properties_definition field_properties_integer_large_definition;                                     /* 0x841833D0 */

_message_definition message_king_update_definition =
{
    _message_king_update,                    /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            { &field_properties_king_score_array_definition, 0, 0, 0 },   /* [ 0] */
            { &field_properties_integer_large_definition, 420, 420, 0 },  /* [ 1] */
