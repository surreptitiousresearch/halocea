/* objects_predict_definition @ 0x821199B4 — hs_function_table entry for the HaloScript "objects_predict" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117FAC -> "objects_predict"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83728128 -> hs_objects_predict_evaluate
...
extern void hs_objects_predict_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition objects_predict_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "objects_predict",           /* name */
    hs_macro_function_parse,     /* parse */
    hs_objects_predict_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
