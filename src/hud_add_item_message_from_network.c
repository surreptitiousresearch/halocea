...
extern void hud_add_item_message_client(__int16 local_player_index, int item_definition_index,
        __int16 quantity, char message_offset);
...
void hud_add_item_message_from_network(message_delta_processor_header *header, network_game_client *client)
{
    ...
    {
        switch ( (unsigned __int16)((equipment_definition *)item_definition)->equipment.powerup_type )
        {
