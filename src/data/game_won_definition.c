/* game_won_definition @ 0x8211B6D4 — hs_function_table entry for the HaloScript "game_won" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8210F660 -> "game_won"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372C288 -> main_won_map_evaluate
...
extern void main_won_map_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition game_won_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "game_won",                  /* name */
    hs_macro_function_parse,     /* parse */
    main_won_map_evaluate,       /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
