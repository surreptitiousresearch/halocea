 ...
 * global_network_game_server_get (likely identical-code-folded distinct server operations); results
 * are discarded. Reproduced verbatim. */
...
void sv_kick(const char *str)
{
    ...
    {
        ship_terminal_printf(global_real_argb_white, "sv_kick is a server-only function!");
    }
}
