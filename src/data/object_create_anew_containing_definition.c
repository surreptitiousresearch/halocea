/* object_create_anew_containing_definition @ 0x82119458 — hs_function_table entry for the HaloScript "object_create_anew_containing" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82118348 -> "object_create_anew_containing"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83727488 -> hs_object_create_anew_containing_evaluate
...
extern void hs_object_create_anew_containing_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition object_create_anew_containing_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "object_create_anew_containing", /* name */
    hs_macro_function_parse,     /* parse */
    hs_object_create_anew_containing_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
