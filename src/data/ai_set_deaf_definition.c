/* ai_set_deaf_definition @ 0x8211A520 — hs_function_table entry for the HaloScript "ai_set_deaf" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821177F0 -> "ai_set_deaf"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729C60 -> ai_scripting_set_deaf_evaluate
...
extern void ai_scripting_set_deaf_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_set_deaf_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_set_deaf",               /* name */
    hs_macro_function_parse,     /* parse */
    ai_scripting_set_deaf_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
