/* field_properties_king_score_array_parameters @ 0x84186B8C (.data, 12 bytes) — the `parameters` blob for an
 ...
 * DB applied_types: _field_type_array_parameters field_properties_king_score_array_parameters;
...
_field_type_array_parameters field_properties_king_score_array_parameters =
{
    16,                                     /* count */
