...
// dsPOOL<dsEVENT_MGR::PENDING_ITEM,256,64>::Get @ 0x82613110
// Non-const accessor: resolve a slot index to a reference to its stored PENDING_ITEM. The slot
// lives in chunk (idx / 256) at position (idx % 256). Asserts idx >= 0, that its chunk is
