/* weapon_magazine_finish_chamber @0x836DB318 — complete a magazine's chambering phase by returning it to
 * the idle state (clears state and state_timer). */
...
void weapon_magazine_finish_chamber(int weapon_index, int16_t magazine_index)
{
