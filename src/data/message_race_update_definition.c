/* message_race_update_definition @ 0x84186A68 (.data, 136 bytes) — the message-delta message definition for
 * `_message_race_update` (id 20): the race game engine's score arrays and lap state.
 ...
 *   +0x00 definition_type                    = 0x00000014 -> _message_race_update
 ...
 *   +0x28   field_references[ 0]             = { 0x84186A00 -> &field_properties_race_score_array_definition, offset 136, baseline_offset 136, initialized 0 }
 *   +0x38   field_references[ 1]             = { 0x84186A00 -> &field_properties_race_score_array_definition, offset 4, baseline_offset 4, initialized 0 }
 *   +0x48   field_references[ 2]             = { 0x84186A00 -> &field_properties_race_score_array_definition, offset 68, baseline_offset 68, initialized 0 }
 *   +0x58   field_references[ 3]             = { 0x841833D0 -> &field_properties_integer_large_definition, offset 0, baseline_offset 0, initialized 0 }
 *   +0x68   field_references[ 4]             = { 0x841833D0 -> &field_properties_integer_large_definition, offset 132, baseline_offset 132, initialized 0 }
 ...
 * 0x84186AF0, i.e. 136 bytes, and 0x28 + (5 + 1) * 16 == 136 — 16 being the DB member stride of
...
extern _field_properties_definition field_properties_race_score_array_definition;                                  /* 0x84186A00 */
extern _field_properties_definition field_properties_integer_large_definition;                                     /* 0x841833D0 */

_message_definition message_race_update_definition =
{
    _message_race_update,                    /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            { &field_properties_race_score_array_definition, 136, 136, 0 },  /* [ 0] */
            { &field_properties_race_score_array_definition, 4, 4, 0 },      /* [ 1] */
            { &field_properties_race_score_array_definition, 68, 68, 0 },    /* [ 2] */
            { &field_properties_integer_large_definition, 0, 0, 0 },         /* [ 3] */
            { &field_properties_integer_large_definition, 132, 132, 0 },     /* [ 4] */
