/* hud_get_timer_ticks_definition @ 0x8211C100 — hs_function_table entry for the HaloScript "hud_get_timer_ticks" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0007 -> hs_type_short_integer
 *   +0x04 name                   = 0x82116498 -> "hud_get_timer_ticks"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D908 -> scripted_hud_get_timer_ticks_evaluate
...
extern void scripted_hud_get_timer_ticks_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition hud_get_timer_ticks_definition =
{
    hs_type_short_integer,       /* return_type */
    { 0, 0 },                    /* _pad02 */
    "hud_get_timer_ticks",       /* name */
    hs_macro_function_parse,     /* parse */
    scripted_hud_get_timer_ticks_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
