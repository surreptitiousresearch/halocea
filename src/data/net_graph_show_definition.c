/* net_graph_show_definition @ 0x8211BDA4 — hs_function_table entry for the HaloScript "net_graph_show" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82116704 -> "net_graph_show"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D160 -> net_graph_change_display_evaluate
...
extern void net_graph_change_display_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition net_graph_show_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "net_graph_show",            /* name */
    hs_macro_function_parse,     /* parse */
    net_graph_change_display_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
