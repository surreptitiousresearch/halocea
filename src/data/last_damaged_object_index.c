/* last_damaged_object_index @ 0x84429C1C (.data, 604 bytes)
 ...
 *   +0x0098 = 0x00000000
 *   +0x009C = 0x00000000
 *   ... 444 further bytes elided; full hex in .sweep/data_image.tsv
 * .data zero-fill (IDA dword_84429C1C, no PDB name).
