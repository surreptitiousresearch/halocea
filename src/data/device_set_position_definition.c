/* device_set_position_definition @ 0x8211A100 — hs_function_table entry for the HaloScript "device_set_position" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82117A80 -> "device_set_position"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x837292D8 -> device_set_desired_position_evaluate
...
extern void device_set_desired_position_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition device_set_position_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "device_set_position",       /* name */
    hs_macro_function_parse,     /* parse */
    device_set_desired_position_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
