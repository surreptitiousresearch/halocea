...
class rendLIGHT_SET; // boundary — rend engine light set (opaque; element is a pointer)

// dsVECTOR<rendLIGHT_SET *,8>::PushBack @ 0x82ABD9F0
...
template<>
rendLIGHT_SET *&dsVECTOR<rendLIGHT_SET *, 8>::PushBack(rendLIGHT_SET *const &val)
{
