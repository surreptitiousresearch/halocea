...
union $60EF112414981E0EE23A1884EE53F811
{
    ...
    __int16 cluster_index;  /* valid when pvs_activation_type == 2 */
};
...
struct object_globals
{
    ...
    __int16       active_garbage_object_count; /* 0x04 */
    char          _pad6[2];                    /* 0x06 */
    ...
    __int16       pvs_activation_type;         /* 0x90 — 1=object, 2=cluster, else inactive */
    char          _pad92[2];                   /* 0x92 */
