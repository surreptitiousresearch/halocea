...
// aiCOORD_GROUP::cbFilterWPSetByDistFromUsedWPs
// ?cbFilterWPSetByDistFromUsedWPs@aiCOORD_GROUP@@QAAXHPAVdsDATA@@AAV2@VsslOBJ_REF@@@Z
//
// SSL callback: resolve the caller-host actor from argv[0] and a distance from argv[1],
// dispatch FilterWPSetByDistFromUsedWPs, and store the bool result.
void aiCOORD_GROUP::cbFilterWPSetByDistFromUsedWPs(int argc, dsDATA *argv, dsDATA &retVal, sslOBJ_REF caller)
{
    ...
    bool result = this->FilterWPSetByDistFromUsedWPs(cbHost, dist);
