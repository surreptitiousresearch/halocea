/* ai_retreat_definition @ 0x8211A660 — hs_function_table entry for the HaloScript "ai_retreat" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82117734 -> "ai_retreat"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729F58 -> ai_scripting_retreat_evaluate
...
extern void ai_scripting_retreat_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition ai_retreat_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "ai_retreat",                /* name */
    hs_macro_function_parse,     /* parse */
    ai_scripting_retreat_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
