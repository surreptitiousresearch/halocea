...
typedef struct actor_input_data
{
    ...
    uint8_t     in_midair;                      /* 0x3C */
    uint8_t     underwater;                     /* 0x3D */
    int16_t             vehicle_driver_type;            /* 0x3E */
    uint8_t     vehicle_passenger;              /* 0x40 */
    uint8_t     vehicle_gunner;                 /* 0x41 */
    uint8_t     vehicle_gunner_bombardment;     /* 0x42 */
    ...
    uint8_t     melee_attacker_attached;        /* 0x94 */
    uint8_t     burning_to_death;               /* 0x95 */
