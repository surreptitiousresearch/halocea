/* message_player_effect_start_definition @ 0x8417C9D0 (.data, 152 bytes) — the message-delta message definition for
 * `_message_player_effect_start` (id 11): a damage/effect has started on a player.
 ...
 *   +0x00 definition_type                    = 0x0000000B -> _message_player_effect_start
 ...
 *   +0x28   field_references[ 0]             = { 0x841833D0 -> &field_properties_integer_large_definition, offset 0, baseline_offset 0, initialized 0 }
 *   +0x38   field_references[ 1]             = { 0x84183A30 -> &field_properties_object_index_definition, offset 4, baseline_offset 4, initialized 0 }
 *   +0x48   field_references[ 2]             = { 0x8417C968 -> &field_properties_damage_data_flags_definition, offset 8, baseline_offset 8, initialized 0 }
 *   +0x58   field_references[ 3]             = { 0x84183CE0 -> &field_properties_vector3d_definition, offset 12, baseline_offset 12, initialized 0 }
 *   +0x68   field_references[ 4]             = { 0x84183438 -> &field_properties_real_definition, offset 24, baseline_offset 24, initialized 0 }
 *   +0x78   field_references[ 5]             = { 0x84183438 -> &field_properties_real_definition, offset 28, baseline_offset 28, initialized 0 }
 ...
 * 0x8417CA68, i.e. 152 bytes, and 0x28 + (6 + 1) * 16 == 152 — 16 being the DB member stride of
...
extern _field_properties_definition field_properties_damage_data_flags_definition;                                 /* 0x8417C968 */
extern _field_properties_definition field_properties_vector3d_definition;                                          /* 0x84183CE0 */
extern _field_properties_definition field_properties_real_definition;                                              /* 0x84183438 */

_message_definition message_player_effect_start_definition =
{
    _message_player_effect_start,            /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_damage_data_flags_definition, 8, 8, 0 },  /* [ 2] */
            { &field_properties_vector3d_definition, 12, 12, 0 },         /* [ 3] */
            { &field_properties_real_definition, 24, 24, 0 },             /* [ 4] */
            { &field_properties_real_definition, 28, 28, 0 },             /* [ 5] */
