/* player0_look_pitch_is_inverted_definition @ 0x8211C3BC — hs_function_table entry for the HaloScript "player0_look_pitch_is_inverted" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x821161FC -> "player0_look_pitch_is_inverted"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DE18 -> player0_look_pitch_is_inverted_evaluate
...
extern void player0_look_pitch_is_inverted_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition player0_look_pitch_is_inverted_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "player0_look_pitch_is_inverted", /* name */
    hs_macro_function_parse,     /* parse */
    player0_look_pitch_is_inverted_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
