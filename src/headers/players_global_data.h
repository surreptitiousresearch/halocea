...
typedef struct players_global_data
{
    ...
    int16_t       local_player_count;                         /* 0x14 */
    int16_t       players_are_double_speed_duration;          /* 0x16 */
    unsigned char all_dead;                                   /* 0x18 */
    unsigned char input_inhibited;                            /* 0x19 */
    int16_t       bsp_switch_trigger_index;                   /* 0x1A */
    int16_t       respawn_failure_reason;                     /* 0x1C */
    unsigned char force_respawn;                              /* 0x1E */
    uint8_t bsp_check_recursive_switch_ticks : 4;     /* 0x1F.0 */
    int8_t          local_player_triggered_switch : 4;        /* 0x1F.4 */
