/* field_properties_game_variant_human_readable_description_definition @ 0x8417D728 (.data, 104 bytes) — the message-delta field-type descriptor for
 * the "game_variant_human_readable_description" network field type (_field_type_wide_string): the encode/decode callback pair the message
 * serializer dispatches through, plus this field's type-specific `parameters` blob.
 * DB applied_types: _field_properties_definition field_properties_game_variant_human_readable_description_definition;
 * Image bytes (big-endian), decoded from the binary .data record:
 *   +0x00 type          = 0x00000006 -> _field_type_wide_string
 *   +0x04 name[75]      = "game_variant_human_readable_description" (36 trailing bytes zero)
 *   +0x4F _pad4F        = 0x00
 *   +0x50 encode        = 0x8379AD10 -> default_wide_string_encoder
 *   +0x54 decode        = 0x8379ADC0 -> default_wide_string_decoder
 *   +0x58 parameters    = 0x8417D654 -> &field_properties_game_variant_human_readable_description_parameters
...
extern _field_type_wide_string_parameters field_properties_game_variant_human_readable_description_parameters; /* 0x8417D654 */

_field_properties_definition field_properties_game_variant_human_readable_description_definition =
{
    _field_type_wide_string,                      /* type */
    "game_variant_human_readable_description",    /* name[75] */
    { 0 },                                        /* _pad4F */
    default_wide_string_encoder,                  /* encode */
    default_wide_string_decoder,                  /* decode */
    &field_properties_game_variant_human_readable_description_parameters, /* parameters */
    -1,                                           /* maximum_size */
    0,                                            /* overhead_bits */
    0                                             /* initialized */
};
