...
typedef struct render_globals
{
    ...
    __int16 local_player_index;       /* 0x08 — local player being rendered this pass */
    __int16 window_index;             /* 0x0A — window being rendered this pass */
    ...
    __int16       visible_sky_index;  /* 0x24E (590) */
    ...
    __int16       rendered_cluster_count;     /* 0xD290 (53904) */
    __int16       _padD292;                   /* 0xD292 (53906) */
    unsigned int  environment_surface_flags[131072]; /* 0xD294 (53908) */
    __int16       environment_surface_count;  /* 0x8D294 (578196) */
    __int16       _pad8D296;                  /* 0x8D296 */
