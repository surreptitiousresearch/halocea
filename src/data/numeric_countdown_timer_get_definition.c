/* numeric_countdown_timer_get_definition @ 0x8211973C — hs_function_table entry for the HaloScript "numeric_countdown_timer_get" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0007 -> hs_type_short_integer
 *   +0x04 name                   = 0x82118180 -> "numeric_countdown_timer_get"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83727B38 -> numeric_countdown_timer_get_evaluate
...
extern void numeric_countdown_timer_get_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition numeric_countdown_timer_get_definition =
{
    hs_type_short_integer,       /* return_type */
    { 0, 0 },                    /* _pad02 */
    "numeric_countdown_timer_get", /* name */
    hs_macro_function_parse,     /* parse */
    numeric_countdown_timer_get_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
