...
extern void hs_print_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition print_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "print",                     /* name */
    hs_macro_function_parse,     /* parse */
    hs_print_evaluate,           /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
