/* actor_unit_control_throw_grenade @0x8371FCB0 — queue a grenade throw on the actor's controlled unit by
...
void actor_unit_control_throw_grenade(int actor_index)
{
