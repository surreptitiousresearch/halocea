/* global_real_argb_green @ 0x84176D6C (.data, 4 bytes)  DB decl: const real_argb_color *global_real_argb_green;
 * Image bytes (big-endian), reconstructed from the binary .data record:
 *   +0x0000 = 0x82113F48 -> &private_real_argb_colors[4]   (0x82113F08 + 16*4)
 *
 * That element decodes to { alpha 1.0, red 0.0, green 1.0, blue 0.0 } = green.
