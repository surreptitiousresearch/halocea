...
// dsPOOL<dsDATA,256,256>::Get @ 0x82613978
// Non-const accessor: resolve a slot index to a reference to its stored dsDATA. The slot lives in
...
template<>
dsDATA &dsPOOL<dsDATA, 256, 256>::Get(int idx)
{
