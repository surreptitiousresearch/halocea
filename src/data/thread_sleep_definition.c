/* thread_sleep_definition @ 0x8211C5EC — hs_function_table entry for the HaloScript "thread_sleep" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x821160A4 -> "thread_sleep"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E330 -> console_func_sleep_evaluate
...
extern void console_func_sleep_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition thread_sleep_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "thread_sleep",              /* name */
    hs_macro_function_parse,     /* parse */
    console_func_sleep_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
