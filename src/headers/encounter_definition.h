...
typedef struct encounter_definition
{
    ...
    int16_t   team_index;        /* 0x24 (disasm-confirmed lhz 0x24) */
    int16_t   version;           /* 0x26 */
    int16_t   searching;         /* 0x28 */
    int16_t   manual_structure_bsp_reference_index; /* 0x2A */
    float     respawn_time_lower_bound;  /* 0x2C */
    float     respawn_time_upper_bound;  /* 0x30 */
    unsigned int unused[18];     /* 0x34 */
    uint16_t pad2;       /* 0x7C */
    int16_t   runtime_structure_bsp_reference_index; /* 0x7E */
