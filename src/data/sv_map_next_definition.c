/* sv_map_next_definition @ 0x8211C808 — hs_function_table entry for the HaloScript "sv_map_next" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115E50 -> "sv_map_next"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E708 -> sv_map_next_evaluate
 *   +0x10 documentation          = 0x82115E00
...
extern void sv_map_next_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition sv_map_next_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "sv_map_next",               /* name */
    hs_macro_function_parse,     /* parse */
    sv_map_next_evaluate,        /* evaluate */
    "<Server Only> Abort the current game and begin the next game in the playlist", /* documentation */
    0,                           /* parameters */
