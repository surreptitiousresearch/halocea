/* cheat_all_weapons_definition @ 0x8211C71C — hs_function_table entry for the HaloScript "cheat_all_weapons" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82115F50 -> "cheat_all_weapons"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E518 -> cheat_all_weapons_evaluate
...
extern void cheat_all_weapons_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition cheat_all_weapons_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "cheat_all_weapons",         /* name */
    hs_macro_function_parse,     /* parse */
    cheat_all_weapons_evaluate,  /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
