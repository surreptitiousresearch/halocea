...
unsigned int default_translated_index_decoder(const _field_properties_definition *const field_properties,
        const void *const baseline_data, unsigned int *destination_data, bitstream_t *const input_stream)
{
    ...
    unsigned int result = bitstream_read_bits(input_stream, &value, parameters[2]);
