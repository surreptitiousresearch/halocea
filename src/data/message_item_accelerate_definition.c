/* message_item_accelerate_definition @ 0x84175D88 (.data, 104 bytes) — the message-delta message definition for
 * `_message_item_accelerate` (id 44): an item has been accelerated.
 ...
 *   +0x00 definition_type                    = 0x0000002C -> _message_item_accelerate
 ...
 *   +0x38   field_references[ 1]             = { 0x84183438 -> &field_properties_real_definition, offset 4, baseline_offset 4, initialized 0 }
 *   +0x48   field_references[ 2]             = { 0x84183758 -> &field_properties_fixed_width_normal_16bit_definition, offset 8, baseline_offset 8, initialized 0 }
 ...
 * 0x84175DF0, i.e. 104 bytes, and 0x28 + (3 + 1) * 16 == 104 — 16 being the DB member stride of
...
extern _field_properties_definition field_properties_fixed_width_normal_16bit_definition;                          /* 0x84183758 */

_message_definition message_item_accelerate_definition =
{
    _message_item_accelerate,                /* definition_type */
    ...
    {                                        /* body_fields */
        ...
        {   /* field_references[count + terminator]: { properties, offset, baseline_offset, initialized } */
            ...
            { &field_properties_real_definition, 4, 4, 0 },                      /* [ 1] */
            { &field_properties_fixed_width_normal_16bit_definition, 8, 8, 0 },  /* [ 2] */
