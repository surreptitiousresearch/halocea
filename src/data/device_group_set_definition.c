/* device_group_set_definition @ 0x8211A180 — hs_function_table entry for the HaloScript "device_group_set" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x82117A24 -> "device_group_set"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x83729420 -> device_group_set_desired_value_evaluate
...
extern void device_group_set_desired_value_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition device_group_set_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "device_group_set",          /* name */
    hs_macro_function_parse,     /* parse */
    device_group_set_desired_value_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
