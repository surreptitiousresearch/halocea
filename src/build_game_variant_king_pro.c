/* build_game_variant_king_pro @0x8374F580 — default "King Pro" variant: King of the Hill (engine 4) with a
 * 300-tick respawn, a 450-tick suicide penalty, and universal flag bit 0x20 also set (flags masked
 * 0xFFFFFE40, OR 0xA3). Non-moving hill. */
...
game_variant * build_game_variant_king_pro(game_variant *result)
{
