/* player0_joystick_set_is_normal_definition @ 0x8211C3D8 — hs_function_table entry for the HaloScript "player0_joystick_set_is_normal" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0005 -> hs_type_boolean
 *   +0x04 name                   = 0x821161DC -> "player0_joystick_set_is_normal"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DE60 -> player0_joystick_set_is_normal_evaluate
...
extern void player0_joystick_set_is_normal_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition player0_joystick_set_is_normal_definition =
{
    hs_type_boolean,             /* return_type */
    { 0, 0 },                    /* _pad02 */
    "player0_joystick_set_is_normal", /* name */
    hs_macro_function_parse,     /* parse */
    player0_joystick_set_is_normal_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
