...
// aiPLANNER::cbNoticeFlyingGrenade @ 0x832542B0
// ?cbNoticeFlyingGrenade@aiPLANNER@@QAAXHPAVdsDATA@@AAV2@VsslOBJ_REF@@@Z
//
// SSL callback: resolve the object reference in argv[0] against the script system to an actor and
// forward it to implNoticeFlyingGrenade. `caller` releases on return.
void aiPLANNER::cbNoticeFlyingGrenade(int /*argc*/, dsDATA *argv, dsDATA & /*retVal*/,
                                      sslOBJ_REF /*caller*/)
{
    sslOBJ_REF ref;
