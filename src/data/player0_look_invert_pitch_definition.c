/* player0_look_invert_pitch_definition @ 0x8211C39C — hs_function_table entry for the HaloScript "player0_look_invert_pitch" function.
 * Initializer reconstructed from the binary .rdata record (32 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x8211621C -> "player0_look_invert_pitch"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372DDD0 -> player0_look_invert_pitch_evaluate
...
extern void player0_look_invert_pitch_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition player0_look_invert_pitch_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "player0_look_invert_pitch", /* name */
    hs_macro_function_parse,     /* parse */
    player0_look_invert_pitch_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
