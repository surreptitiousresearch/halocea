...
typedef struct effect_datum
{
    ...
    int16_t             scale_a_function_index; /* 0x08 */
    int16_t             scale_b_function_index; /* 0x0A */
    int16_t             change_color_index;     /* 0x0C */
