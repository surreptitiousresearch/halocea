...
// ds_data::dsDATA_TYPE_IMPL<haloPLAYER_ACTIONS_ENV>::Save @ 0x823BEE10
// Virtual override. No disk serializer for this type: touch the stored value, strong-assert("0")
// and return failure (0). fioFILE is a boundary.
template<>
int ds_data::dsDATA_TYPE_IMPL<haloPLAYER_ACTIONS_ENV>::Save(const unsigned int *storage, fioFILE *pFile) const
{
