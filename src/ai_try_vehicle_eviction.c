/* ai_try_vehicle_eviction @0x836E8840 — decide whether an actor may evict a passenger to take a vehicle
...
extern void actor_stimulus_vehicle_eviction(int actor_index);
