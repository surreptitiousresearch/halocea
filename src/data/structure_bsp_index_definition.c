/* structure_bsp_index_definition @ 0x8211B310 — hs_function_table entry for the HaloScript "structure_bsp_index" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0007 -> hs_type_short_integer
 *   +0x04 name                   = 0x82116E14 -> "structure_bsp_index"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372BDC0 -> global_structure_bsp_index_get_evaluate
...
extern void global_structure_bsp_index_get_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition structure_bsp_index_definition =
{
    hs_type_short_integer,       /* return_type */
    { 0, 0 },                    /* _pad02 */
    "structure_bsp_index",       /* name */
    hs_macro_function_parse,     /* parse */
    global_structure_bsp_index_get_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
