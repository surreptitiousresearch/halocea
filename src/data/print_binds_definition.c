/* print_binds_definition @ 0x8211C558 — hs_function_table entry for the HaloScript "print_binds" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116114 -> "print_binds"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372E1F0 -> input_abstraction_print_binds_evaluate
...
extern void input_abstraction_print_binds_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition print_binds_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "print_binds",               /* name */
    hs_macro_function_parse,     /* parse */
    input_abstraction_print_binds_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
