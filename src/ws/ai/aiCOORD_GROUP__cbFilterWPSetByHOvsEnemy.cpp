...
// 0x83231028  aiCOORD_GROUP::cbFilterWPSetByHOvsEnemy
// ssl callback: retrieve the float arg (argv[1]) and the caller-host actor (argv[0]),
// dispatch FilterWPSetByHOvsEnemy, return the bool.
void aiCOORD_GROUP::cbFilterWPSetByHOvsEnemy(int argc, dsDATA *argv, dsDATA &retVal, sslOBJ_REF caller)
{
    ...
    bool result = this->FilterWPSetByHOvsEnemy(host, floatArg);
