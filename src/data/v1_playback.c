/* v1_playback @ 0x84177D1C -- second-order .data; animation_playback reconstructed from binary bytes. */
#include <stdint.h>
...
animation_playback v1_playback = {
    .initialize_event_stream = recorded_animation_initialize_event_stream_v1,
    .apply_event_stream      = recorded_animation_apply_event_stream_v1,
};
