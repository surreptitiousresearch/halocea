/* time_code_reset_definition @ 0x8211C15C — hs_function_table entry for the HaloScript "time_code_reset" function.
 * Initializer reconstructed from the binary .rdata record (28 bytes, big-endian):
 *   +0x00 return_type            = 0x0004 -> hs_type_void
 *   +0x04 name                   = 0x82116468 -> "time_code_reset"
 *   +0x08 parse                  = 0x837787E0 -> hs_macro_function_parse
 *   +0x0C evaluate               = 0x8372D970 -> scripted_hud_time_code_reset_evaluate
...
extern void scripted_hud_time_code_reset_evaluate(int16_t function_index, int thread_index, unsigned char initialize);

const hs_function_definition time_code_reset_definition =
{
    hs_type_void,                /* return_type */
    { 0, 0 },                    /* _pad02 */
    "time_code_reset",           /* name */
    hs_macro_function_parse,     /* parse */
    scripted_hud_time_code_reset_evaluate, /* evaluate */
    "",                          /* documentation */
    0,                           /* parameters */
    0,                           /* console_flags */
    { 0 },                       /* _pad19 */
