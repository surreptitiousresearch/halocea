/* actor_stimulus_prop_sighted @0x837D40C0 — an actor sighted a prop: if the prop is active (byte @
...
void actor_stimulus_prop_sighted(int actor_index, int prop_index, uint8_t new_enemy)
{
