/* D3DDevice_SetStreamSource_Inline_3 @0x83712988 */
...
void D3DDevice_SetStreamSource_Inline_3(D3DDevice *pDevice, unsigned int StreamNumber, D3DVertexBuffer *pStreamData, unsigned int OffsetInBytes, unsigned int Stride)
{
